...
(function (game) {
    var scene;
    (function (scene_1) {
        var WeatherFlower = /** @class */ (function (_super) {
            __extends(WeatherFlower, _super);
            function WeatherFlower(app) {
                var _this = _super.call(this, app) || this;
                _this._assetsLoader = new AssetsLoader();
                _this._assetsLoader.load([game.Path.atlas_scene + "weather/hua.atlas"], Handler.create(_this, _this.onResComplete));
                return _this;
            }
            WeatherFlower.prototype.onResComplete = function () {
                //贴图集
                //雪素材
                this.TEXTURES_SETTING = new Array(4);
                this.TEXTURES_SETTING[0] = Laya.loader.getRes("scene/weather/hua/hua_far.png"); //远
                this.TEXTURES_SETTING[1] = Laya.loader.getRes("scene/weather/hua/hua_far2.png"); //远2
                this.TEXTURES_SETTING[2] = Laya.loader.getRes("scene/weather/hua/hua_mid.png"); //中
                this.TEXTURES_SETTING[3] = Laya.loader.getRes("scene/weather/hua/hua_nearly.png"); //近
                //远景，中景，近景数量定义
                this.LEN_SETTING = new Array(this.TEXTURES_SETTING.length);
                this.LEN_SETTING[0] = 25;
                this.LEN_SETTING[1] = 25;
                this.LEN_SETTING[2] = 20;
                this.LEN_SETTING[3] = 5;
                //远景，中景，近景速度定义
            ...
            WeatherFlower.prototype.enable = function () {
                _super.prototype.enable.call(this);
                //开始播放下雨
                // this._app.playMusic("sounds/s_snow.mp3", 0);
            };
            WeatherFlower.prototype.disable = function () {
                _super.prototype.disable.call(this);
                //开始播放下雨
                this._app.stopMusic();
            };
            WeatherFlower.prototype.onUpdate = function (scene, g) {
        ...
        scene_1.WeatherFlower = WeatherFlower;
