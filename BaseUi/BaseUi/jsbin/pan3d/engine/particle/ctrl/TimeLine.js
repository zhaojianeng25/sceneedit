    ...
    (function (me) {
        var TimeLine = /** @class */ (function (_super) {
            ...
            TimeLine.prototype.updateMatrix = function (posMatrix, $particle) {
                ...
                posMatrix.prependRotation($particle.data.rotationV3d.z, me.Vector3D.Z_AXIS);
                posMatrix.prependRotation($particle.data.rotationV3d.y, me.Vector3D.Y_AXIS);
                posMatrix.prependRotation($particle.data.rotationV3d.x, me.Vector3D.X_AXIS);
            };
            ...
            TimeLine.prototype.getTarget = function () {
                ...
                for (var i = 0; i < this._keyFrameAry.length; i++) {
                    if (this._keyFrameAry[i].frameNum * me.Scene_data.frameTime < this._time) {
                        flag = i;
                    }
                    else {
                        break;
                ...
                if (flag != this.targetFlag) {
                    ...
                    if (flag >= (this._keyFrameAry.length - 1) || !this._currentKeyFrame) {
                        ...
                        this.visible = true;
                        this.enterKeyFrame(this._currentKeyFrame.animData, this._currentKeyFrame.frameNum * me.Scene_data.frameTime, this._currentKeyFrame.baseValue);
                    }
                }
            };
            ...
            TimeLine.prototype.setAllByteInfo = function ($byte, $allObj) {
                ...
                this.beginTime = this._keyFrameAry[0].frameNum * me.Scene_data.frameTime;
                this._currentKeyFrame = this._keyFrameAry[0];
            };
