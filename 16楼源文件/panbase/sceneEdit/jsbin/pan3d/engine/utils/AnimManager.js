    ...
    (function (me) {
        var AnimManager = /** @class */ (function () {
            ...
            AnimManager.prototype.getAnimData = function ($url, $fun) {
                ...
                me.LoadManager.getInstance().load($url, me.LoadManager.BYTE_TYPE, function ($byte, _fun) {
                    //this.loadObjCom($byte, _fun, $url);
                    var animData = _this.readData(new me.Pan3dByteArray($byte), $url);
                    _fun(animData);
                }, $fun);
            };
