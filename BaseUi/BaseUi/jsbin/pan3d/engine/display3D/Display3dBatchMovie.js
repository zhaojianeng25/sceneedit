    ...
    (function (me) {
        var Display3dBatchMovie = /** @class */ (function (_super) {
            ...
            Display3dBatchMovie.prototype.setVcMatrix = function ($mesh) {
                me.Scene_data.context3D.setVcMatrix4fv($mesh.material.shader, "viewMatrix3D", me.Scene_data.viewMatrx3D.m);
                me.Scene_data.context3D.setVcMatrix4fv($mesh.material.shader, "camMatrix3D", me.Scene_data.cam3D.cameraMatrix.m);
                me.Scene_data.context3D.setVcMatrix4fv($mesh.material.shader, "rotationMatrix3D", this._rotationMatrix.m);
                for (var i = 0; i < this.batchPos.length; i++) {
                    me.Scene_data.context3D.setVcMatrix4fv($mesh.material.shader, "posMatrixAry[" + i + "]", this.batchPos[i].posMatrix.m);
                }
            };
            ...
            Display3dBatchMovie.prototype.setVa = function ($mesh) {
                ...
                me.Scene_data.context3D.setVa(1, 3, $mesh.uvBuffer);
        ...
        me.Display3dBatchMovie = Display3dBatchMovie;
