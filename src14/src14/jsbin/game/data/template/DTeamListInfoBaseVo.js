...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var DTeamListInfoBaseVo = /** @class */ (function () {
                function DTeamListInfoBaseVo() {
                }
                DTeamListInfoBaseVo.prototype.parse = function (data) {
                ...
                return DTeamListInfoBaseVo;
            }());
            template.DTeamListInfoBaseVo = DTeamListInfoBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=DTeamListInfoBaseVo.js.map