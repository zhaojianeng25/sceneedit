...
(function (game) {
    ...
    (function (shader) {
        ...
        var TreeSprite = /** @class */ (function (_super) {
            ...
            function TreeSprite(mapWater, textureUrl, waterSampleUrl) {
             ...
             * @param	ib 顶点索引数组。
             */
            TreeSprite.prototype.init = function (textureUrl, waterSampleUrl) {
            ...
            //重写渲染函数。
            TreeSprite.prototype.customRender = function (context, x, y) {
                if (!this._texture)
                    return;
            ...
            TreeSprite.prototype.clear = function () {
                //素材卸载
                this._assetsLoader.clear();
            };
            return TreeSprite;
        }(Laya.Sprite));
        shader.TreeSprite = TreeSprite;
    })(shader = game.shader || (game.shader = {}));
})(game || (game = {}));
//# sourceMappingURL=TreeSprite.js.map