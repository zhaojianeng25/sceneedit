...
(function (Pan3d) {
    ...
    (function (me) {
        ...
        me.AlphaUIShader = AlphaUIShader;
        var AlphaUIRenderComponent = /** @class */ (function (_super) {
            ...
            AlphaUIRenderComponent.prototype.initData = function () {
                ...
                me.ProgrmaManager.getInstance().registe(AlphaUIShader.AlphaUiShader, new AlphaUIShader);
                this.shader = me.ProgrmaManager.getInstance().getProgram(AlphaUIShader.AlphaUiShader);
                ...
                this.alphaLocation = me.Scene_data.context3D.getLocation(this.program, "alpha");
            };
        ...
        me.AlphaUIRenderComponent = AlphaUIRenderComponent;
        var AlphaFrameCompenent = /** @class */ (function (_super) {
            ...
            AlphaFrameCompenent.prototype.setVc = function (program, index) {
                ...
                me.Scene_data.context3D.setVc1fv(program, "alpha[" + index + "]", [this.alpha]);
            };
            return AlphaFrameCompenent;
        }(me.FrameCompenent));
        me.AlphaFrameCompenent = AlphaFrameCompenent;
        ...
        me.AlphaGrid9UICompenent = AlphaGrid9UICompenent;
        ...
        me.AlphaUICompenent = AlphaUICompenent;
        ...
        me.AlphaUiContianer = AlphaUiContianer;
