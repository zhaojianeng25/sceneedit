module Pan3d {
    ...
    export  class LabelTextFont {
        ...
        */
        public static writeTextLabel($uiAtlas: UIAtlas, $key: string, $str: string, fontsize: number = 12, $align: CanvasTextAlign = TextAlign.CENTER, $maxWidth: number = 500,
        ...
        public static writeText($uiAtlas: UIAtlas, $key: string,
            $x: number, $y: number,
            $str: string, fontsize: number, fontColor: string, $maxWidth: number = 0, bolder: boolean = false, $textAlign: CanvasTextAlign = TextAlign.LEFT): Array<number> {
