...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var GemEffect_PointCardBaseVo = /** @class */ (function () {
                function GemEffect_PointCardBaseVo() {
                }
                GemEffect_PointCardBaseVo.prototype.parse = function (data) {
                ...
                return GemEffect_PointCardBaseVo;
            }());
            template.GemEffect_PointCardBaseVo = GemEffect_PointCardBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=GemEffect_PointCardBaseVo.js.map