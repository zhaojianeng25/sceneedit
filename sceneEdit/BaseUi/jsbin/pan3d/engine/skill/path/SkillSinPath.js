    ...
    (function (me) {
        var SkillSinPath = /** @class */ (function (_super) {
            ...
            SkillSinPath.prototype.update = function (t) {
                ...
                if (!this.hasReached) {
                    var targetDistance = me.Vector3D.distance(this.basePos, this.currentTargetPos);
            ...
            SkillSinPath.prototype.getOffset = function (ypos) {
                ...
                var offsetv3d = this._currentDirect.cross(new me.Vector3D(0, 1, 0));
