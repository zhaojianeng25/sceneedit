...
(function (game) {
    ...
    (function (modules) {
        ...
        (function (roleinfo) {
            ...
            (function (models) {
                /** 角色系统数据存放类 */
                var RoleInfoModel = /** @class */ (function () {
                    function RoleInfoModel() {
                        /**x洗点道具配置表 */
                        this.addPointResetItemConfigBinDic = {};
                        /**s升级经验限制表 */
                        this.CResMoneyConfigBinDic = {};
                        /**y一级属性转换表 */
                        this.CAttrModDataBinDic = {};
                        /**NPCMT3买卖物品表 */
                        this.CNpcSaleBinDic = {};
                        /**z职业转盘表 */
                        this.CSchoolWheelBinDic = {};
                        /**人物称谓表 */
                        this.CRoleTitleBinDic = {};
                        /**j加点方案切换消耗 */
                        this.CaddpointchangeDic = {};
                        /** 战斗中人物的属性发生改变 */
                        this.battleRoleAttr = new Laya.Dictionary;
                        /**当前页码 */
                        this.currentKey = 1;
                    ...
                    RoleInfoModel.getInstance = function () {
                        if (!this._instance) {
                            this._instance = new RoleInfoModel();
                        }
                        return this._instance;
                    };
                    RoleInfoModel.clearModelData = function () {
                    ...
                    /** 获得职业图标路径 */
                    RoleInfoModel.prototype.setZhiyeImg = function (school) {
                        var skinStr = "";
                        switch (school) {
                            case zhiye.yunxiao:
