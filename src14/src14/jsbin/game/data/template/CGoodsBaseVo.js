...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var CGoodsBaseVo = /** @class */ (function () {
                function CGoodsBaseVo() {
                    this.currencys = []; //货币1,货币2
                    this.oldprices = []; //价格1,价格2
                    this.prices = []; //现价1,现价2
                }
                CGoodsBaseVo.prototype.parse = function (data) {
                    ...
                    this.spendItemId = data.getUint32();
            ...
            template.CGoodsBaseVo = CGoodsBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=CGoodsBaseVo.js.map