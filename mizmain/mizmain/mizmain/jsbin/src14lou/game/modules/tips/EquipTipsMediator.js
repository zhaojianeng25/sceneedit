...
(function (game) {
    ...
    (function (modules) {
        ...
        (function (tips) {
            /** 单个物品详情tips */
            var EquipTipsMediator = /** @class */ (function (_super) {
                __extends(EquipTipsMediator, _super);
                function EquipTipsMediator(uiLayer, app) {
                    ...
                    /**装备表2 */
                    _this.equipItemAttrData = game.modules.strengThening.models.StrengTheningModel._instance.equipItemAttrData;
                    /**装备的属性和附加属性 */
                    ...
                    _this.skill = null;
                    /**洗练界面 */
                    _this.jumpXilianPage = 2;
                    _this.parame = new Laya.Dictionary();
                    _this.equipId = -1;
                    _this.key = -1;
                    _this.packid = -1;
                    _this.equipdType = -1;
                    ...
                    _this._viewUI = new ui.common.component.EquipTipsUI();
                 ...
                 * @param itemId 物品id
                 */
                EquipTipsMediator.prototype.showItemTips = function (parame, WearId) {
                    this.parame = parame;
                    ...
                    if (this.packid == BagTypes.BAG && tips.models.TipsModel.getInstance().whichView != modules.ModuleNames.PET) {
                ...
                /**拍卖行显示装备详细信息 */
                EquipTipsMediator.prototype.showAuctionItemTips = function (parame) {
                    this._viewUI.xiangqing.visible = false;
                    this._viewUI.morebtn_list.visible = false;
                    var itemId = parame.get("itemId");
                    var key = parame.get("key");
                ...
                EquipTipsMediator.prototype.setTipsBtn = function () {
                ...
                /**设置按钮的值 */
                EquipTipsMediator.prototype.setWearEquipTipsBtn = function () {
                ...
                /**显示宠物装备 */
                EquipTipsMediator.prototype.showpetequip = function (itemId, key, packid, equipdType, parame) {
                    this._viewUI.xiangqing.visible = false;
                    this._viewUI.morebtn_list.visible = false;
                ...
                /**点击装备按钮 */
                EquipTipsMediator.prototype.onZBBtn = function (sexNeed, shape, parame, num) {
                    if (this.ItemPurpose == ItemPurpose.ITEM_TRANSFER) { /** 转移 */
                        var num_1 = -1;
                        var depotId = -1;
                        var dstPos = -1;
                        var npcId = -1;
                        RequesterProtocols._instance.c2s_CTrans_Item(BagTypes.TEMP, this.key, num_1, BagTypes.BAG, dstPos, depotId, npcId);
                    }
                        ...
                        if (petNum == 0) { /** 没有宠物，弹窗提示 先自己手写，后面统一放入配置表取*/
                            var prompt_1 = this.chatMessageTips[150078].msg;
                ...
                /** 存取按钮点击事件 */
                EquipTipsMediator.prototype.onAccessEvent = function (parame) {
                ...
                /** 关闭界面 */
                EquipTipsMediator.prototype.closeWindow = function () {
                 ...
                 * @param packid  背包id
                 */
                EquipTipsMediator.prototype.showAttr = function (itemId, key, packid) {
                    var html = "";
                    var _itemType = BagModel.getInstance().getItemTotalType(itemId);
                    if (_itemType == ItemTotalType.PetEquipItem) { //是宠物装备
                        var equipTips = this.equipTips;
                        var petEquipTips = void 0;
                        for (var i = 0; i < equipTips.length; i++) {
                            var _tipsPackid = equipTips[i].packid; //背包id
                            var _tipsKey = equipTips[i].keyinpack; //key
                        ...
                        if (!petEquipTips) {
                            if (packid == BagTypes.PETEQUIP) {
                                ...
                                RequesterProtocols._instance.c2s_CGetPetEquip_Tips(modules.pet.models.PetModel._instance.petbasedata.key, key);
                            }
                            else if (packid == BagTypes.DEPOT || packid == BagTypes.TEMP) {
                                modules.createrole.models.LoginProxy.getInstance().once(modules.createrole.models.GetItemTips_EVENT, this, this.showAttr, [itemId, key, packid]);
                        ...
                        if (!petEquipTips)
                            return;
                        var petEquipSkill = petEquipTips.tips.skill;
                        ...
                        var petEquipEffect = petEquipTips.tips.effect;
                        ...
                        var suiting = StrengTheningModel.getInstance().equipEffectData[itemId].suiting; //获得该宠物装备所对应的套装id
                        var _petSuitBuffData = PetModel.getInstance().petSuitBuffData[suiting];
                        if (_petSuitBuffData) { //如果有宠物装备套装效果
                            var haveSuitNum = 0; //已集齐的宠物套装数量
                            if (packid == BagTypes.PETEQUIP) {
                                var suits = [_petSuitBuffData.item1, _petSuitBuffData.item2, _petSuitBuffData.item3, _petSuitBuffData.item4]; //存放宠物装备套装装备id的数值
                                var petEquipBag = BagModel.getInstance().bagMap[packid];
                                var petKey = PetModel.getInstance().petbasedata.key;
                                var items = petEquipBag.get(petKey).items; //存放宠物身上装备背包的道具数据的数组
                                for (var i_1 = 0; i_1 < items.length; i_1++) {
                                    var petEquipItemId = items[i_1].id;
                                    if (petEquipItemId == suits[0] || petEquipItemId == suits[1] || petEquipItemId == suits[2] || petEquipItemId == suits[3]) {
                                        haveSuitNum++;
                                    }
                                }
                            }
                            var petSuitName = _petSuitBuffData.name; //宠物套装名字
                            html = "<span style='color:#FBDC47;fontSize:24'>" + petSuitName + "</span><br/>";
                            html += "<span style='fontSize:15'>&nbsp;&nbsp;&nbsp;&nbsp;  </span><br>";
                            var petSuitProp = _petSuitBuffData.prop; ////宠物套装效果
                        ...
                        var petEquipScore = petEquipTips.tips.equipscore; //宠物装备评分
                        html += "<span style='fontSize:15'>&nbsp;&nbsp;&nbsp;&nbsp;  </span><br>";
                        html += "<span style='color:#FBDC47;fontSize:24'>" + this.cstringResConfigData[111].msg + "" + 0 + "</span><br/>";
                        var petEquipDestribe = this.itemAttrData[itemId].destribe; //宠物装备描述
                        html += "<span style='fontSize:15'>&nbsp;&nbsp;&nbsp;&nbsp;  </span><br>";
                    ...
                    if (packid == -1) {
                        ...
                        for (var i = 0; i < this.equipTips.length; i++) {
                            ...
                            if (equPackid == packid && equKey == key) {
                                ...
                                var diamond = this.equipTips[i].tips.diamondID;
                                ...
                                if (diamond.length != 0) {
                                    ...
                                    for (var _index = 0; _index < diamond.length; _index++) {
                                        html += "<span style='fontSize:15'>&nbsp;&nbsp;&nbsp;&nbsp;  </span><br>";
                                ...
                                //附魔后临时加成
                                var fuMoShuXingData = this.equipTips[i].tips.enhancement;
                                ...
                                var _itemData = void 0;
                                if (packid == BagTypes.DEPOT) {
                                    var depotId = this.parame.get("currdepot");
                ...
                /** 设置富文本内容 */
                EquipTipsMediator.prototype.setHtml_innerHTML = function (html) {
                ...
                * @param itemId
                */
                EquipTipsMediator.prototype.isWearCurrentEqu = function (itemId) {
                ...
                /** 查看别人的装备tips */
                EquipTipsMediator.prototype.showOtherItem = function (itemId, key, isShowOtherEqu) {
                    var html = "<span style='color:#FBDC47;fontSize:24'>" + this.cstringResConfigData[122].msg + "</span><br/>";
                    var equipDetail = null;
                    ...
                    if (isShowOtherEqu) {
                        ...
                        if (!equipDetail) { //可能是珍品回收那边查看装备道具信息
                            equipDetail = modules.bag.models.BagModel.getInstance().equipItemRecoverInfoTips;
                ...
                /**拍卖行查看别人装备 */
                EquipTipsMediator.prototype.showAuctionItem = function (itemId, key) {
                    var html = "";
                    var equipDetail = null;
                    var baseAttr = null;
                    var addAttr = null;
                 ...
                 * 点击装备详情按钮
                 */
                EquipTipsMediator.prototype.onXangqBtn = function (equid) {
                ...
                /**显示基础属性 */
                EquipTipsMediator.prototype.getBaseAttr = function (baseAttr, attributeDesConfigData, equipIteminfoData, equid) {
                    var html = "";
                    var html2 = "";
                    if (baseAttr != null) {
                        var baseAttrKeys = baseAttr.keys;
                 ...
                 */
                EquipTipsMediator.prototype.onMoreBtn = function (equid, key, packid, isWearEquip) {
                ...
                /**设置morelsit坐标 */
                EquipTipsMediator.prototype.setMorebtnlistPos = function () {
                    var _this = this;
                ...
                /**设置装备tips更多按钮的类型 */
                EquipTipsMediator.prototype.setEquiplistArr = function (equid, key, packid, morebtnlist) {
                    var arr = [];
                ...
                /**设置宠物装备tips更多按钮类型 */
                EquipTipsMediator.prototype.setPetEquipArr = function (equid, morebtnlist) {
                    var arr = [];
                    var bCanSale = this.itemAttrData[equid].bCanSale;
                    if (bCanSale != 0) {
                        arr.push({ more_btn: this.cstringResConfigData[11042].msg });
                ...
                /**更多按钮列表选择 */
                EquipTipsMediator.prototype.moreBtnSelect = function (index) {
                    var cell = this._viewUI.morebtn_list.getCell(index);
                    var morebtn = cell.getChildByName("more_btn");
                    ...
                    if (btnname == this.cstringResConfigData[11773].msg) {
                        ...
                        if (nquality >= EquipNquality.Purple) { /** 跳转到确认界面 */
                            ...
                            tips.models.TipsProxy.getInstance().once(tips.models.TIPS_ON_OK, this, this.onOkBtn);
                        ...
                        modules.sale.models.SaleModel.getInstance().tiaozhuanid = ViewIndex.SELL;
                        modules.ModuleManager.show(modules.ModuleNames.SALE, this._app);
                        var currView = tips.models.TipsModel.getInstance().whichView;
                        if (currView.length != 0) {
                            modules.ModuleManager.hide(currView);
                        ...
                        var parame_1 = new Laya.Dictionary();
                        parame_1.set("contentId", 140402);
                        parame_1.set("parame", [this.itemName]);
                        ...
                        var _tipsModule = new tips.tipsModule(this._viewUI, this._app, TIPS_TYPE.CLIENT_TIPS_MESSAGE, parame_1);
                    }
                    this.closeWindow();
                };
                /** 取消丢弃道具 */
                EquipTipsMediator.prototype.sureOnCancelForAbandon = function () {
                    tips.models.TipsProxy.getInstance().off(tips.models.TIPS_ON_OK, this, this.sureOnOKForAbandon);
                };
                /** 确定丢弃道具 */
                EquipTipsMediator.prototype.sureOnOKForAbandon = function () {
                 ...
                 *分解
                 */
                EquipTipsMediator.prototype.onOkBtn = function () {
                    RequesterProtocols._instance.c2s_resolve_equip(this.key);
                };
                /**
                 * @param isshow 是否显示按钮 @param access 1 存入 2取出
                 */
                EquipTipsMediator.prototype.show = function (parame, isShow, access) {
                 ...
                 * 临时背包装备转移按钮事件
                 */
                EquipTipsMediator.prototype.temporaryequip = function (srcpackid, itemKey, number, dstpackid) {
                    ...
                    if (bag.items.length != bag.capacity) { //如果背包格子和数据源相等说明他满了
                        ...
                        var prompt_2 = this.chatMessageTips[145950].msg;
                        this.DisappearMessageTipsMediator = new DisappearMessageTipsMediator(this._app);
                        this.DisappearMessageTipsMediator.onShow(prompt_2);
                    }
                };
                EquipTipsMediator.prototype.hide = function () {
                    _super.prototype.hide.call(this);
                };
                EquipTipsMediator.prototype.getView = function () {
                    return this._viewUI;
                };
                return EquipTipsMediator;
            }(game.modules.UiMediator));
            tips.EquipTipsMediator = EquipTipsMediator;
        })(tips = modules.tips || (modules.tips = {}));
    })(modules = game.modules || (game.modules = {}));
})(game || (game = {}));
//# sourceMappingURL=EquipTipsMediator.js.map