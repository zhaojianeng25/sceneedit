    ...
    (function (me) {
        var Display3DModelPartilce = /** @class */ (function (_super) {
            ...
            Display3DModelPartilce.prototype.creatData = function () {
                this.data = new me.ParticleModelData;
            };
            ...
            Display3DModelPartilce.prototype.setVa = function () {
                ...
                me.Scene_data.context3D.setWriteDepth(this.data._depthMode == 1);
            ...
            Display3DModelPartilce.prototype.updateUV = function () {
                var currentFrame = Math.floor((this._time / me.Scene_data.frameTime) / this.data._animInterval);
                ...
                this._resultUvVec[0] += this._time / me.Scene_data.frameTime * this.data._uSpeed;
                this._resultUvVec[1] += this._time / me.Scene_data.frameTime * this.data._vSpeed;
            };
            return Display3DModelPartilce;
        }(me.Display3DParticle));
        me.Display3DModelPartilce = Display3DModelPartilce;
