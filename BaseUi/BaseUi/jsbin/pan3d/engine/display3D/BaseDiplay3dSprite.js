...
(function (Pan3d) {
    ...
    (function (me) {
        ...
        me.BaseDiplay3dShader = BaseDiplay3dShader;
        var BaseDiplay3dSprite = /** @class */ (function (_super) {
            ...
            BaseDiplay3dSprite.prototype.initData = function () {
                me.ProgrmaManager.getInstance().registe(BaseDiplay3dShader.BaseDiplay3dShader, new BaseDiplay3dShader);
                this.shader = me.ProgrmaManager.getInstance().getProgram(BaseDiplay3dShader.BaseDiplay3dShader);
            ...
            BaseDiplay3dSprite.prototype.loadTexture = function () {
                var $ctx = me.UIManager.getInstance().getContext2D(128, 128, false);
                $ctx.fillStyle = "rgb(255,255,255)";
                $ctx.fillRect(0, 0, 128, 128);
                this._uvTextureRes = me.TextureManager.getInstance().getCanvasTexture($ctx);
            };
            ...
            BaseDiplay3dSprite.prototype.update = function () {
                if (this.objData && this.objData.indexBuffer && this._uvTextureRes) {
                    ...
                    me.Scene_data.context3D.setRenderTexture(this.shader, "s_texture", this._uvTextureRes.texture, 0);
                    me.Scene_data.context3D.drawCall(this.objData.indexBuffer, this.objData.treNum);
                }
            };
            return BaseDiplay3dSprite;
        }(me.Display3D));
        me.BaseDiplay3dSprite = BaseDiplay3dSprite;
