module Pan3d.me {
    ...
    export class GameStart {
        ...
        public init(): void {
            ...
            $baseUiList.push({ xmlurl: "ui/arpgui/textlist.txt", picurl: "ui/arpgui/textlist.png", name: UIData.textlist });
            $baseUiList.push({ xmlurl: "ui/uidata/public/public.txt", picurl: "ui/uidata/public/public.png", name: UIData.publicUi });
