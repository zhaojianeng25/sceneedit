...
(function (Pan3d) {
    ...
    (function (me) {
        var Display3DBoneShader = /** @class */ (function (_super) {
            ...
            Display3DBoneShader.prototype.getVertexShaderString = function () {
                var $str = "attribute vec3 pos;" +
                    ...
                    "varying vec2 v0;\n" +
                    me.MaterialAnimShader.getMd5M44Str() +
                    "void main(void)" +
                    "{" +
                    "v0 = v2uv;\n" +
        ...
        me.Display3DBoneShader = Display3DBoneShader;
        var Display3DBonePartilce = /** @class */ (function (_super) {
            ...
            Display3DBonePartilce.prototype.creatData = function () {
                this.data = new me.ParticleBoneData;
            };
            ...
            Display3DBonePartilce.prototype.setVc = function () {
                var currentFrame = float2int((this._time / me.Scene_data.frameTime) / 2);
                ...
                */
                ...
                me.Scene_data.context3D.setVc4fv(this.data.materialParam.shader, "boneQ", $dualQuatFrame.quat); //旋转
                me.Scene_data.context3D.setVc3fv(this.data.materialParam.shader, "boneD", $dualQuatFrame.pos); //所有的位移
                this.setMaterialVc();
            };
            Display3DBonePartilce.prototype.setVa = function () {
                var tf = me.Scene_data.context3D.pushVa(this.modeldata.meshData.vertexBuffer);
                if (!tf) {
                    me.Scene_data.context3D.setVaOffset(0, 3, this.modeldata.meshData.stride, 0);
                    me.Scene_data.context3D.setVaOffset(1, 2, this.modeldata.meshData.stride, 12);
                    me.Scene_data.context3D.setVaOffset(3, 4, this.modeldata.meshData.stride, 20);
                    me.Scene_data.context3D.setVaOffset(2, 4, this.modeldata.meshData.stride, 36);
                }
                ...
                me.Scene_data.context3D.drawCall(this.modeldata.meshData.indexBuffer, this.modeldata.meshData.treNum);
            };
        ...
        me.Display3DBonePartilce = Display3DBonePartilce;
