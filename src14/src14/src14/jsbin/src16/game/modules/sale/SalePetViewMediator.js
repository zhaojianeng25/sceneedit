...
(function (game) {
    ...
    (function (modules) {
        var sale;
        (function (sale) {
            var SalePetViewMediator = /** @class */ (function (_super) {
                __extends(SalePetViewMediator, _super);
                function SalePetViewMediator(uiLayer, app, isBuyPet) {
                    ...
                    _this._viewUI = new ui.common.SalePetShelfUI();
                    ...
                    _this._viewUI.buyPet_btn.on(LEvent.MOUSE_DOWN, _this, _this.buyPet);
                    sale.models.SaleProxy._instance.on(sale.models.SMarketPetTips, _this, _this.showPetDetails, [SaleModel.salePetMarketUpOrDown.MarketDown]);
                    _this.addPetSkillList();
                    _this._viewUI.buyPet_box.visible = false;
                    if (isBuyPet == true) {
                        _this.showbuyPet();
                    }
                    return _this;
                ...
                /**显示购买宠物 */
                SalePetViewMediator.prototype.showbuyPet = function () {
                    this._viewUI.buyPet_box.visible = true;
                    this._viewUI.cancel_btn.visible = false;
                    this._viewUI.shelf_btn.visible = false;
                };
                /**购买宠物 */
                SalePetViewMediator.prototype.buyPet = function () {
                    sale.models.SaleProxy._instance.event(sale.models.butPet);
                    this.hide();
                };
                /**提示信息弹窗 */
                SalePetViewMediator.prototype.onBoothTipsBtn = function () {
                ...
                /**显示宠物详情 */
                SalePetViewMediator.prototype.showPetDetails = function (salePetMarketUpOrDown, pet) {
                    var petId = pet.id;
                ...
                /**显示小键盘 */
                SalePetViewMediator.prototype.onPrice = function () {
                ...
                /**通过小键盘设置价格 */
                SalePetViewMediator.prototype.setPetPrice = function (num) {
                    if (num == -2) { //点击了ok
                 ...
                 * @param petKey
                 */
                SalePetViewMediator.prototype.onMarket = function (petKey) {
                ...
                /**元宝兑换金币 */
                SalePetViewMediator.prototype.goCharge = function (yuanbao) {
                ...
                /**通过元宝购买物品 */
                SalePetViewMediator.prototype.buySliverFromYuanBao = function (yuanbao) {
                ...
                /**充值 */
                SalePetViewMediator.prototype.goRecharge = function () {
                ...
                /**选择显示宠物技能、资质、属性 */
                SalePetViewMediator.prototype.ontab = function (pet, index) {
                ...
                /**初始化技能格子 */
                SalePetViewMediator.prototype.addPetSkillList = function () {
                 ...
                 * 显示宠物技能
                 */
                SalePetViewMediator.prototype.showPetSkill = function (pet) {
                    var petId = pet.id;
                    var skillidArr = []; //技能
                ...
                /**点击技能 */
                SalePetViewMediator.prototype.petskilllistSelect = function (index) {
                 ...
                 * 宠物资质
                 */
                SalePetViewMediator.prototype.showPetZizhi = function (pet) {
                 ...
                 * 宠物属性
                 */
                SalePetViewMediator.prototype.showPetAttr = function (pet) {
                 ...
                 * @param price 价格
                 */
                SalePetViewMediator.prototype.CMarketUp = function (containertype, key, num, price) {
                ...
                SalePetViewMediator.prototype.getPetPrice = function (price) {
                    this.petprice = price;
                };
                SalePetViewMediator.prototype.show = function () {
                    _super.prototype.show.call(this);
                };
                SalePetViewMediator.prototype.hide = function () {
                    game.modules.tips.models.TipsProxy.getInstance().off(game.modules.tips.models.ON_KRYBOARD, this, this.setPetPrice);
                    _super.prototype.hide.call(this);
                };
                SalePetViewMediator.prototype.getView = function () {
                    return this._viewUI;
                };
                return SalePetViewMediator;
            }(game.modules.UiMediator));
            sale.SalePetViewMediator = SalePetViewMediator;
        })(sale = modules.sale || (modules.sale = {}));
    })(modules = game.modules || (game.modules = {}));
})(game || (game = {}));
//# sourceMappingURL=SalePetViewMediator.js.map