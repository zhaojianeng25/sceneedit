        ...
        var AxisRotaion = /** @class */ (function (_super) {
            ...
            Object.defineProperty(AxisRotaion.prototype, "data", {
                set: function (value) {
                    ...
                    this.axis = new me.Vector3D(Number(vc[0]), Number(vc[1]), Number(vc[2]));
                    vc = String(value[3].value).split("|");
                    this.axisPos = new me.Vector3D(Number(vc[0]) * 100, Number(vc[1]) * 100, Number(vc[2]) * 100);
