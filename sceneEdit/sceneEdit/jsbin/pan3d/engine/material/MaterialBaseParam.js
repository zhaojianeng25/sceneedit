...
(function (Pan3d) {
    ...
    (function (me) {
        var MaterialBaseParam = /** @class */ (function (_super) {
            ...
            MaterialBaseParam.prototype.setData = function ($material, $ary) {
                ...
                for (var i = 0; i < $ary.length; i++) {
                    var obj = $ary[i];
                    if (obj.type == 0) {
                        var texItem = new me.DynamicBaseTexItem();
                        ...
                        mipmap = 0;
                        me.TextureManager.getInstance().getTexture(me.Scene_data.fileRoot + obj.url, function ($textres) {
                        ...
                        var constItem = new me.DynamicBaseConstItem();
        ...
        me.MaterialBaseParam = MaterialBaseParam;
