...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var FoodAndDrugEffect_PointCardBaseVo = /** @class */ (function () {
                function FoodAndDrugEffect_PointCardBaseVo() {
                }
                FoodAndDrugEffect_PointCardBaseVo.prototype.parse = function (data) {
                ...
                return FoodAndDrugEffect_PointCardBaseVo;
            }());
            template.FoodAndDrugEffect_PointCardBaseVo = FoodAndDrugEffect_PointCardBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=FoodAndDrugEffect_PointCardBaseVo.js.map