    ...
    (function (me) {
        var Display3DParticle = /** @class */ (function (_super) {
            ...
            function Display3DParticle() {
                ...
                _this.modelMatrix = new me.Matrix3D();
                return _this;
            }
            ...
            Object.defineProperty(Display3DParticle.prototype, "cantUseEffectsLev", {
                //特效配置等级显示  是否能显示
                get: function () {
                    var temp = this.data._renderPriority <= me.Scene_data.effectsLev; //0
                    return !temp;
                },
                enumerable: true,
                configurable: true
            ...
            Display3DParticle.prototype.update = function () {
                ...
                me.Scene_data.context3D.setBlendParticleFactors(this.data._alphaMode);
                me.Scene_data.context3D.cullFaceBack(this.data.materialParam.material.backCull);
                if (this.data.materialParam) {
                    me.Scene_data.context3D.setProgram(this.data.materialParam.program);
                }
                this.updateMatrix();
                this.setVc();
                this.setVa();
            ...
            Display3DParticle.prototype.setMaterialVc = function () {
                ...
                var t = this._time % (me.Scene_data.frameTime * this.data._life);
                ...
                me.Scene_data.context3D.setVc4fv(this.data.materialParam.shader, "fc", this.data.materialParam.material.fcData);
            ...
            Display3DParticle.prototype.setMaterialTexture = function () {
                ...
                for (var i = 0; i < texVec.length; i++) {
                    ...
                    me.Scene_data.context3D.setRenderTexture(this.data.materialParam.shader, texVec[i].name, texVec[i].texture, texVec[i].id, true);
                }
                ...
                for (var i = 0; i < texDynamicVec.length; i++) {
                    ...
                    me.Scene_data.context3D.setRenderTexture(this.data.materialParam.shader, texDynamicVec[i].target.name, texDynamicVec[i].texture, texDynamicVec[i].target.id, true);
                }
            };
            ...
            Display3DParticle.prototype.getVector3DByObject = function (obj) {
                ...
                return new me.Vector3D(obj.x, obj.y, obj.z, obj.w);
            };
        ...
        me.Display3DParticle = Display3DParticle;
