...
(function (game) {
    ...
    (function (modules) {
        ...
        (function (tips) {
            /** 装备对比详情tips */
            var EquipCompareTipsMediator = /** @class */ (function (_super) {
                __extends(EquipCompareTipsMediator, _super);
                function EquipCompareTipsMediator(uiLayer, app) {
                    ...
                    _this.access = -1;
                    _this.ItemPurpose = -1;
                    _this.minbgHtmlHeight = 120; //最小的高度
                    _this.packid = -1;
                    _this.skill = null;
                    _this.effect = null;
                    _this._viewUI = new ui.common.component.EquipCompareTipsUI();
                 ...
                 * @param packid 背包id
                 */
                EquipCompareTipsMediator.prototype.showBagEquipTips = function (WearId, equipdType, parame) {
                    this.parame = parame;
                ...
                /** 存取按钮点击事件 */
                EquipCompareTipsMediator.prototype.onAccessEvent = function (parame) {
                 ...
                 * @param shape 角色造型id
                 */
                EquipCompareTipsMediator.prototype.onZBBtn = function (sexNeed, shape) {
                ...
                /** 关闭界面 */
                EquipCompareTipsMediator.prototype.closeWindow = function () {
                 ...
                 * @param itemId
                 */
                EquipCompareTipsMediator.prototype.showWearEquipTips = function (equipId, wearKey) {
                    var name = this.itemAttrData[equipId].name; //名称
                    var destribe = this.itemAttrData[equipId].destribe; //描述
                    var effectdes = this.itemAttrData[equipId].effectdes; //功能说明
                    var itemtypeid = this.itemAttrData[equipId].itemtypeid; //类型
                    ...
                    var bagType;
                    var _itemType = BagModel.getInstance().getItemTotalType(equipId); //装备道具类型
                 ...
                 * @param key 装备key
                 */
                EquipCompareTipsMediator.prototype.showAttr = function (itemId, packid, key) {
                    ...
                    if (_itemType == ItemTotalType.PetEquipItem) { //是宠物装备
                        ...
                        if (packid == null) { //显示别人的装备信息
                            ...
                            if (!equipTips) { //可能是珍品回收那边查看装备道具信息
                                equipTips = modules.bag.models.BagModel.getInstance().equipItemRecoverInfoTips;
                            }
                ...
                /**显示别人的装备属性 */
                EquipCompareTipsMediator.prototype.showOtherEquip = function (equipTips, key, itemId, html) {
                    var baseAttr, addAttr, skill, effect, endure, equipscore;
                    if (key) {
                 ...
                 * 点击装备详情按钮
                 */
                EquipCompareTipsMediator.prototype.onxiangqBtn = function (equipId) {
                ...
                /**显示装备的基础属性 */
                EquipCompareTipsMediator.prototype.getBaseAttr = function (baseAttr, attributeDesConfigData, equipIteminfoData, equid) {
                    var html = "";
                    var html2 = "";
                    if (baseAttr != null) {
                        var baseAttrKeys = baseAttr.keys;
                ...
                /**点击更多按钮 */
                EquipCompareTipsMediator.prototype.onMoreBtn = function (equid, key, packid) {
                ...
                /**设置morelsit坐标 */
                EquipCompareTipsMediator.prototype.setMorebtnlistPos = function () {
                    var _this = this;
                 ...
                 * @param itemId
                 */
                EquipCompareTipsMediator.prototype.isWearCurrentEqu = function (itemId) {
                    var eequiptype = this.equipEffectData[itemId].eequiptype; //选中装备的部件id
                    var bagType;
                    var _itemType = BagModel.getInstance().getItemTotalType(itemId); //装备道具类型
                    if (_itemType == ItemTotalType.PetEquipItem) { //是宠物装备
                        bagType = BagTypes.PETEQUIP;
                    }
                    else { //人物角色身上的装备
                ...
                /**点击更多按钮列表 */
                EquipCompareTipsMediator.prototype.moreBtnSelect = function (index) {
                 ...
                 *分解
                 */
                EquipCompareTipsMediator.prototype.onOkBtn = function () {
                    RequesterProtocols._instance.c2s_resolve_equip(this.key);
                };
                /**
                 * @param isshow 是否显示按钮 @param access 1 存入 2取出
                 */
                EquipCompareTipsMediator.prototype.show = function (parame, isShow, access) {
                ...
                EquipCompareTipsMediator.prototype.hide = function () {
                    _super.prototype.hide.call(this);
                };
                EquipCompareTipsMediator.prototype.getView = function () {
                    return this._viewUI;
                };
                return EquipCompareTipsMediator;
            }(game.modules.UiMediator));
            tips.EquipCompareTipsMediator = EquipCompareTipsMediator;
        })(tips = modules.tips || (modules.tips = {}));
    })(modules = game.modules || (game.modules = {}));
})(game || (game = {}));
//# sourceMappingURL=EquipCompareTipsMediator.js.map