...
(function (game) {
    ...
    (function (modules) {
        var sale;
        (function (sale) {
            var SaleSearchViewMediator = /** @class */ (function (_super) {
                __extends(SaleSearchViewMediator, _super);
                function SaleSearchViewMediator(app) {
                    var _this = _super.call(this) || this;
                    /**以name为key 的三级摆摊列表 */
                    _this.cMarketThreeTableDataForName = SaleModel._instance.cMarketThreeTableDataForName;
                    /**复合表 */
                    ...
                    /**道具类型表 */
                    _this.itemTypeData = StrengTheningModel._instance.itemTypeData;
                    /**装备附加属性表 */
                    _this.equipAddattributelibData = StrengTheningModel._instance.equipAddattributelibData;
                    /**宠物一级属性转换表 */
                    _this.petCPetAttrModDataData = game.modules.pet.models.PetModel._instance.petCPetAttrModDataData;
                    /**程序内字符串表 */
                    _this.cstringResConfigData = game.modules.tips.models.TipsModel._instance.cstringResConfigData;
                    /**搜素的所有name */
                    _this.searchTotalNameArr = [];
                    /**搜索的结果 */
                    _this.searchResultArr = [];
                    /**装备部件名称 */
                    _this.equPartsArr = [];
                    /**装备等级 */
                    _this.equLevelArr = [];
                    /**基础属性  **/
                    _this.equBaseAttrArr = sale.models.SaleModel._instance.equBaseAttrArr;
                    /**特效 */
                    _this.equTeXiaoArr = [];
                    /**特技 */
                    _this.equTeJiArr = [];
                    /**装备附加属性 */
                    _this.equAddAttr = sale.models.SaleModel._instance.equAddAttr;
                    /**宠物资质评分 */
                    _this.petZizhiArr = sale.models.SaleModel._instance.petZizhiArr;
                    /**宠物基础属性 */
                    _this.petBaseAttr = sale.models.SaleModel._instance.petBaseAttr;
                    _this.equSearchDic = new Laya.Dictionary();
                    _this.petSearchDic = new Laya.Dictionary();
                    /**普通宠物 */
                    _this.ordinaryPet = [];
                    /**灵兽 */
                    _this.lingshou = [];
                    ...
                    _this.petSkill = [];
                    /**选择的是否是灵兽 */
                    _this.isLingshou = false;
                    _this._viewUI = new ui.common.SaleSearchUI();
                    _this._app = app;
                    _this._clientWidth = app.clientWidth;
                    _this._clientHeight = app.clientHeight;
                    _this.uiLayer = app.uiRoot.general;
                    _this._SaleSearchBtnListViewMediator = new sale.SaleSearchBtnListViewMediator(_this._viewUI);
                    _this._SaleSearchPetViewMediator = new sale.SaleSearchPetViewMediator(_this._viewUI);
                    _this._viewUI.searchResult_list.visible = false;
                    _this._viewUI.searchRecord_list.visible = false;
                    _this._viewUI.close_btn.on(LEvent.MOUSE_DOWN, _this, _this.closeThisView);
                    _this._viewUI.search_btn.on(LEvent.MOUSE_DOWN, _this, _this.onSearch); //普通搜索
                    _this._viewUI.searchBtn_tab.selectHandler = new Handler(_this, _this.loadSearchView);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListTipsbtn, _this, _this.flushEquPartsBtn);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEqulevelbtn, _this, _this.flushEquLevelBtn);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEquBastAttrbtn1, _this, _this.flushEquBaseAttr1);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEquBastAttrbtn2, _this, _this.flushEquBaseAttr2);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEquBastAttrbtn3, _this, _this.flushEquBaseAttr3);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEquTeXiao, _this, _this.flushEquTeXiao);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEquTeJi, _this, _this.flushEquTeJi);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListEquAddAttr, _this, _this.flushAddAttr);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListordinaryPet, _this, _this.flushOrdinaryPet);
                    sale.models.SaleProxy._instance.on(sale.models.onSaleListlingchong, _this, _this.flushLingshou);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetSkill, _this, _this.flushPetSkill);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetZizhi1, _this, _this.flushPetZizhi1);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetZizhi2, _this, _this.flushPetZizhi2);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetZizhi3, _this, _this.flushPetZizhi3);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetBaseAttr1, _this, _this.flushPetBaseAttr1);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetBaseAttr2, _this, _this.flushPetBaseAttr2);
                    sale.models.SaleProxy._instance.on(sale.models.onSalePetBaseAttr3, _this, _this.flushPetBaseAttr3);
                    sale.models.SaleProxy._instance.once(sale.models.SMarketSearchResult, _this, _this.gemEquipPetSeek); //珍品装备或者宠物搜索返回
                    _this.loadSearchView(0);
                    _this.searchFirstTab();
                    _this.initAllListData();
                    return _this;
                }
                /**关闭当前界面 */
                SaleSearchViewMediator.prototype.closeThisView = function () {
                    modules.ModuleManager.show(modules.ModuleNames.SALE, this._app);
                    this.hide();
                };
                /**选择显示搜索界面、搜索装备界面、搜索宠物界面 */
                SaleSearchViewMediator.prototype.loadSearchView = function (index) {
                ...
                /**搜索装备 */
                SaleSearchViewMediator.prototype.showSearchEqu = function () {
                ...
                /**搜索宠物 */
                SaleSearchViewMediator.prototype.showSearchPet = function () {
                ...
                /**初始化数据 */
                SaleSearchViewMediator.prototype.initAllListData = function () {
                    var partsArr = [210, 211, 212, 206, 207, 200, 209, 208, 202, 204, 203, 201]; //装备二级菜单序号id
                 ...
                 * @param index 上架中 公示中
                 */
                SaleSearchViewMediator.prototype.flushEquSellRadio = function (index) {
                 ...
                 */
                SaleSearchViewMediator.prototype.flushEququality = function (index) {
                    this._viewUI.color_radio.selectedIndex = index;
                };
                /**刷新装备部件 */
                SaleSearchViewMediator.prototype.flushEquPartsBtn = function (index) {
                ...
                /**装备等级 */
                SaleSearchViewMediator.prototype.flushEquLevelBtn = function (index) {
                ...
                /**装备基础属性1 */
                SaleSearchViewMediator.prototype.flushEquBaseAttr1 = function (index) {
                ...
                /**装备基础属性2 */
                SaleSearchViewMediator.prototype.flushEquBaseAttr2 = function (index) {
                    var name = this.equBaseAttrArr[index].name;
                    var id = this.equBaseAttrArr[index].id;
                ...
                /**装备基础属性3 */
                SaleSearchViewMediator.prototype.flushEquBaseAttr3 = function (index) {
                    var name = this.equBaseAttrArr[index].name;
                    var id = this.equBaseAttrArr[index].id;
                ...
                /**装备特效 */
                SaleSearchViewMediator.prototype.flushEquTeXiao = function (index) {
                ...
                /**装备特技 */
                SaleSearchViewMediator.prototype.flushEquTeJi = function (index) {
                ...
                /**装备附加属性 */
                SaleSearchViewMediator.prototype.flushAddAttr = function (index) {
                ...
                /**普通宠物 */
                SaleSearchViewMediator.prototype.flushOrdinaryPet = function (index) {
                ...
                /**灵兽 */
                SaleSearchViewMediator.prototype.flushLingshou = function (index) {
                ...
                /**宠物技能 */
                SaleSearchViewMediator.prototype.flushPetSkill = function () {
                ...
                /**宠物资质1 */
                SaleSearchViewMediator.prototype.flushPetZizhi1 = function (index) {
                ...
                /**宠物资质2 */
                SaleSearchViewMediator.prototype.flushPetZizhi2 = function (index) {
                    var name = this.petZizhiArr[index].name;
                    var id = this.petZizhiArr[index].id;
                ...
                /**宠物资质3 */
                SaleSearchViewMediator.prototype.flushPetZizhi3 = function (index) {
                    var name = this.petZizhiArr[index].name;
                    var id = this.petZizhiArr[index].id;
                ...
                /**宠物基础属性1 */
                SaleSearchViewMediator.prototype.flushPetBaseAttr1 = function (index) {
                ...
                /**宠物基础属性2 */
                SaleSearchViewMediator.prototype.flushPetBaseAttr2 = function (index) {
                    var name = this.petBaseAttr[index].name;
                    var id = this.petBaseAttr[index].id;
                ...
                /**宠物基础属性3 */
                SaleSearchViewMediator.prototype.flushPetBaseAttr3 = function (index) {
                    var name = this.petBaseAttr[index].name;
                    var id = this.petBaseAttr[index].id;
                ...
                /**增加属性1 */
                SaleSearchViewMediator.prototype.onAddAttr1 = function () {
                    this._viewUI.baseAttr2_box.visible = true;
                };
                /**增加属性2 */
                SaleSearchViewMediator.prototype.onAddAttr2 = function () {
                    this._viewUI.baseAttr3_box.visible = true;
                };
                /**减少属性2 */
                SaleSearchViewMediator.prototype.onlessAttr2 = function () {
                ...
                /**减少属性3 */
                SaleSearchViewMediator.prototype.onlessAttr3 = function () {
                    this._viewUI.baseAttr3_box.visible = false;
                };
                /**
                 * 普通搜索
                 */
                SaleSearchViewMediator.prototype.onSearch = function () {
                ...
                /**珍品装备 珍品宠物搜索返回的结果 */
                SaleSearchViewMediator.prototype.gemEquipPetSeek = function () {
                    var browsetype = SaleModel._instance.SearchResultData.get("browsetype");
                    if (browsetype == 1) {
                        SaleModel.getInstance().isSeekback = true;
                        sale.models.SaleModel._instance.tiaozhuanid = ViewIndex.BUY;
                        sale.models.SaleProxy._instance.event(sale.models.buyGemEguipPetSeek);
                    }
                    else {
                        SaleModel.getInstance().isSeekback = true;
                        sale.models.SaleModel._instance.tiaozhuanid = ViewIndex.PUBLICITY;
                        sale.models.SaleProxy._instance.event(sale.models.attentionGemEguipPetSeekSearch, actiontype.search);
                    }
                    this.closeThisView();
                };
                /**搜索 */
                SaleSearchViewMediator.prototype.search = function (searchResult) {
                    var selectedIndex = this._viewUI.saleState_radio.selectedIndex;
                    if (selectedIndex == 0) {
                        sale.models.SaleProxy._instance.event(sale.models.buySearch, searchResult);
                        sale.models.SaleModel._instance.tiaozhuanid = 0;
                    }
                    else {
                        sale.models.SaleProxy._instance.event(sale.models.attentionSearch, searchResult);
                        sale.models.SaleModel._instance.tiaozhuanid = 2;
                    }
                    this.closeThisView();
                };
                /**
                 * 珍品装备搜索
                 */
                SaleSearchViewMediator.prototype.onEquSearchBtn = function () {
                 ...
                 * 宠物搜索
                 */
                SaleSearchViewMediator.prototype.petSearch = function () {
                    var petSkillIndexArr = SaleModel._instance.petSkillIndexArr;
                    ...
                    if (petZizhi1 != undefined) {
                        ...
                        var attrval = zizhi1;
                        zizhi.push({ attrid: attrid, attrval: attrval });
                    }
                    ...
                    if (petBaseAttrId1 != undefined) {
                        ...
                        attr.push({ attrid: attrid, attrval: attrval });
                    }
                 ...
                 * 搜索珍品宠物界面重置
                 */
                SaleSearchViewMediator.prototype.petRestInitUI = function () {
                    var arruitext = []; //text文本框数组
                    var arruibutton = []; //button按钮数组
                    arruitext.push(this._viewUI.petMinPrice_input, this._viewUI.petMaxPrice_input, this._viewUI.petMinLevel_input, this._viewUI.petMaxLevel_input, this._viewUI.petSkillNum_input, this._viewUI.zizhi1_input, this._viewUI.petBaseAttr1_input, this._viewUI.petBaseAttr2_input, this._viewUI.petBaseAttr3_input, this._viewUI.petScore_input, this._viewUI.zizhi2_input, this._viewUI.zizhi3_input);
                    arruibutton.push(this._viewUI.zizhi1_btn, this._viewUI.zizhi2_btn, this._viewUI.zizhi3_btn, this._viewUI.petBaseAttr_btn1, this._viewUI.petBaseAttr2_btn, this._viewUI.petBaseAttr3_btn, this._viewUI.petSkill_btn);
                ...
                /**显示搜索结果 */
                SaleSearchViewMediator.prototype.showSearchResult = function () {
                ...
                /**渲染 */
                SaleSearchViewMediator.prototype.searchRender = function (cell, index) {
                    var resultBtn = cell.getChildByName("result_Btn");
                    resultBtn.label = this.searchResultArr[index].name;
                    resultBtn.on(LEvent.MOUSE_UP, this, this.onResultBtn, [cell, index]);
                };
                /**选择结果 */
                SaleSearchViewMediator.prototype.onResultBtn = function (cell, index) {
                    var resultBtn = cell.getChildByName("result_Btn");
                ...
                /**显示普通搜索记录 */
                SaleSearchViewMediator.prototype.showSearchRecord = function () {
                    var searchRecordArr = SaleModel._instance.searchRecordArr;
                ...
                /**搜索记录列表渲染 */
                SaleSearchViewMediator.prototype.searchRecordRender = function (cell, index) {
                    var record = cell.getChildByName("record_Btn");
                    record.label = SaleModel._instance.searchRecordArr[index];
                    record.on(LEvent.MOUSE_UP, this, this.onRecordBtn, [cell, index]);
                };
                /**点击搜索记录 */
                SaleSearchViewMediator.prototype.onRecordBtn = function (cell, index) {
                    var record = cell.getChildByName("record_Btn");
                    var name = record.label;
                    this._viewUI.input.text = name;
                };
                /**遍历一级表 */
                SaleSearchViewMediator.prototype.searchFirstTab = function () {
                ...
                /**遍历二级表 */
                SaleSearchViewMediator.prototype.searchSecondTab = function (index) {
                ...
                /**遍历三级表 */
                SaleSearchViewMediator.prototype.searchThreeTab = function (index) {
                 ...
                 */
                SaleSearchViewMediator.prototype.CMarketSearchEquip = function (euqiptype, level, pricemin, pricemax, effect, skill, color, basicattr, additionalattr, totalattr, score, sellstate) {
                 ...
                 * @param sellstate 出售状态 1上架，2公示
                 */
                SaleSearchViewMediator.prototype.CMarketSearchPet = function (pettype, levelmin, levelmax, pricemin, pricemax, zizhi, skills, totalskillnum, attr, score, sellstate) {
                ...
                SaleSearchViewMediator.prototype.show = function () {
                    _super.prototype.show.call(this);
                };
                SaleSearchViewMediator.prototype.hide = function () {
                    _super.prototype.hide.call(this);
                };
                SaleSearchViewMediator.prototype.getView = function () {
                    return this._viewUI;
                };
                return SaleSearchViewMediator;
            }(game.modules.ModuleMediator));
            sale.SaleSearchViewMediator = SaleSearchViewMediator;
        })(sale = modules.sale || (modules.sale = {}));
    })(modules = game.modules || (game.modules = {}));
})(game || (game = {}));
//# sourceMappingURL=SaleSearchViewMediator.js.map