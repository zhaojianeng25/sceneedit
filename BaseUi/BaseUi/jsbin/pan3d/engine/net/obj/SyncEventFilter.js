    ...
    (function (me) {
        var SyncEventFilter = /** @class */ (function (_super) {
            ...
            SyncEventFilter.prototype.SyncEventFilter = function () {
                ...
                this._curObj = null;
                this._curEventCount = 0;
                this._eventParams = new me.Pan3dByteArray;
                this._eventParams.endian = me.Endian.LITTLE_ENDIAN;
            ...
            SyncEventFilter.prototype.pushUpdateMask = function (typ, mask) {
                ...
                var i;
                if (typ == me.SyncEvent.TYPE_STRING) {
            ...
            SyncEventFilter.prototype.pushBinlog = function (binlog) {
                ...
                if (binlog._atomic_opt != 0)
                    return;
                var opt = (binlog._typ == me.SyncEvent.TYPE_STRING ? SyncEventFilter.EV_UPDATE_S : SyncEventFilter.EV_UPDATE_I);
        ...
        me.SyncEventFilter = SyncEventFilter;
