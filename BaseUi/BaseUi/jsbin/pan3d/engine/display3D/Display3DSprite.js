    ...
    (function (me) {
        var Display3DSprite = /** @class */ (function (_super) {
            ...
            function Display3DSprite() {
                ...
                _this.time = 0;
                _this.dynamic = false;
                _this._rotationMatrix = new me.Matrix3D;
                return _this;
            ...
            Object.defineProperty(Display3DSprite.prototype, "aabbVect", {
                get: function () {
                    if (!this._aabbVect) {
                        ...
                        this._aabbVect.push(new me.Vector3D(ax, ay, az));
                        this._aabbVect.push(new me.Vector3D(ax + bx, ay, az));
                        this._aabbVect.push(new me.Vector3D(ax, ay + by, az));
                        this._aabbVect.push(new me.Vector3D(ax, ay, az + bz));
                        this._aabbVect.push(new me.Vector3D(ax + bx, ay + by, az));
                        this._aabbVect.push(new me.Vector3D(ax + bx, ay, az + bz));
                        this._aabbVect.push(new me.Vector3D(ax, ay + by, az + bz));
                        this._aabbVect.push(new me.Vector3D(ax + bx, ay + by, az + bz));
                    }
            ...
            Display3DSprite.prototype.setObjUrl = function (value) {
                var _this = this;
                this.objurl = value;
                me.ObjDataManager.getInstance().getObjData(me.Scene_data.fileRoot + value, function ($obj) {
                    _this.objData = $obj;
                    if (_this.material) {
                        if (!_this.objData.tangentBuffer) {
                            me.ObjDataManager.getInstance().creatTBNBuffer(_this.objData);
                        }
                    }
                });
            };
            Display3DSprite.prototype.setPicUrl = function ($str) {
                var _this = this;
                this.picUrl = $str;
                me.TextureManager.getInstance().getTexture(me.Scene_data.fileRoot + $str, function ($texture) {
            ...
            Display3DSprite.prototype.setLightMapUrl = function (value) {
                ...
                var url = me.Scene_data.fileRoot + value;
                me.TextureManager.getInstance().getTexture(url, function ($texture) {
            ...
            Display3DSprite.prototype.setMaterialUrl = function (value, $paramData) {
                ...
                this.materialUrl = me.Scene_data.fileRoot + value;
                //var materialshader: MaterialShader = new MaterialShader;
                me.MaterialManager.getInstance().getMaterialByte(this.materialUrl, function ($material) {
                    ...
                    if ($paramData) {
                        _this.materialParam = new me.MaterialBaseParam();
                        _this.materialParam.setData(_this.material, $paramData);
                    }
                }, null, true, me.MaterialShader.MATERIAL_SHADER, me.MaterialShader);
            };
                ...
                set: function (value) {
                    ...
                    if (this._lightProbe) {
                        if (!this.resultSHVec) {
                            ...
                            for (var i = 0; i < 9; i++) {
                                this.resultSHVec.push(new me.Vector3D(ary[i], ary[i], ary[i]));
                            }
                        }
                    }
                },
            ...
            Display3DSprite.prototype.updateMaterial = function () {
                ...
                me.Scene_data.context3D.setBlendParticleFactors(this.material.blendMode);
                me.Scene_data.context3D.cullFaceBack(this.material.backCull);
                this.updateBind();
                ////console.log(this.material.url);
                me.Scene_data.context3D.setProgram(this.material.shader.program);
                me.Scene_data.context3D.setWriteDepth(this.material.writeZbuffer);
                me.Scene_data.context3D.setVcMatrix4fv(this.material.shader, "posMatrix3D", this.posMatrix.m);
                this.setCam();
            ...
            Display3DSprite.prototype.setMaterialVaIndependent = function () {
                ...
                if (!(this.material.directLight || this.material.noLight)) {
                    me.Scene_data.context3D.setVa(2, 2, this.objData.lightUvBuffer);
                }
                if (this.material.usePbr || this.material.directLight) {
                    me.Scene_data.context3D.setVa(3, 3, this.objData.normalsBuffer);
                    me.Scene_data.context3D.setVcMatrix3fv(this.material.shader, "rotationMatrix3D", this._rotationData);
                }
                if (this.material.useNormal) {
                    me.Scene_data.context3D.setVa(4, 3, this.objData.tangentBuffer);
                    me.Scene_data.context3D.setVa(5, 3, this.objData.bitangentBuffer);
                }
            };
            Display3DSprite.prototype.setMaterialVaCompress = function () {
                var tf = me.Scene_data.context3D.pushVa(this.objData.vertexBuffer);
                if (tf) {
                    return;
                }
                me.Scene_data.context3D.setVaOffset(0, 3, this.objData.stride, 0);
                me.Scene_data.context3D.setVaOffset(1, 2, this.objData.stride, this.objData.uvsOffsets);
                if (!(this.material.directLight || this.material.noLight)) {
                    me.Scene_data.context3D.setVaOffset(2, 2, this.objData.stride, this.objData.lightuvsOffsets);
                }
                if (this.material.usePbr || this.material.directLight) {
                    me.Scene_data.context3D.setVaOffset(3, 3, this.objData.stride, this.objData.normalsOffsets);
                    me.Scene_data.context3D.setVcMatrix3fv(this.material.shader, "rotationMatrix3D", this._rotationData);
                }
                if (this.material.useNormal) {
                    me.Scene_data.context3D.setVaOffset(4, 3, this.objData.stride, this.objData.tangentsOffsets);
                    me.Scene_data.context3D.setVaOffset(5, 3, this.objData.stride, this.objData.bitangentsOffsets);
                }
            };
            Display3DSprite.prototype.setDirectLight = function ($material) {
                if ($material.directLight) {
                    me.Scene_data.context3D.setVc3fv($material.shader, "ambientColor", me.Scene_data.light.ambientColor);
                    me.Scene_data.context3D.setVc3fv($material.shader, "sunDirect", me.Scene_data.light.sunDirect);
                    me.Scene_data.context3D.setVc3fv($material.shader, "sunColor", me.Scene_data.light.sunColor);
                }
            };
            Display3DSprite.prototype.setCam = function () {
                ...
                me.Scene_data.context3D.setVpMatrix(this.material.shader, me.Scene_data.vpMatrix.m);
            };
            Display3DSprite.prototype.setBind = function ($bindTarget, $bindSocket) {
                this.bindTarget = $bindTarget;
                this.bindSocket = $bindSocket;
                this.bindMatrix = new me.Matrix3D();
            };
            Display3DSprite.prototype.setGroup = function ($pos, $rotaion, $scale) {
                ...
                this.groupMatrix = new me.Matrix3D();
                this.groupRotationMatrix = new me.Matrix3D();
                this.groupMatrix.isIdentity = false;
                this.groupMatrix.identity();
                this.groupMatrix.appendScale($scale.x, $scale.y, $scale.z);
                this.groupMatrix.appendRotation($rotaion.x, me.Vector3D.X_AXIS);
                this.groupMatrix.appendRotation($rotaion.y, me.Vector3D.Y_AXIS);
                this.groupMatrix.appendRotation($rotaion.z, me.Vector3D.Z_AXIS);
                ...
                this.groupRotationMatrix.prependRotation($rotaion.z, me.Vector3D.Z_AXIS);
                this.groupRotationMatrix.prependRotation($rotaion.y, me.Vector3D.Y_AXIS);
                this.groupRotationMatrix.prependRotation($rotaion.x, me.Vector3D.X_AXIS);
            };
            ...
            Display3DSprite.prototype.setBaseMaterialVc = function ($material) {
                var t = 0;
                if ($material.hasTime) {
                    t = (me.TimeUtil.getTimer() - this.time) % 100000 * 0.001;
                }
                if ($material.hasTime || $material.usePbr || $material.useKill) {
                    me.Scene_data.context3D.setVc4fv($material.shader, "fc0", [1, 0, $material.killNum, t]); //sceneEvnScale,null,killNum,time;
                }
                if ($material.scaleLightMap) {
                    me.Scene_data.context3D.setVcFloat($material.shader, "scalelight", me.Scene_data.scaleLight);
                }
                if ($material.usePbr || $material.fogMode == 1) {
                    this.setCamPos($material);
                }
                if ($material.fogMode != 0) {
                    me.Scene_data.context3D.setVc2fv($material.shader, "fogdata", me.Scene_data.fogData);
                    me.Scene_data.context3D.setVc3fv($material.shader, "fogcolor", me.Scene_data.fogColor);
                }
            };
            Display3DSprite.prototype.setCamPos = function ($material) {
                ...
                $material.updateCam(me.Scene_data.cam3D.x / 100, me.Scene_data.cam3D.y / 100, me.Scene_data.cam3D.z / 100);
            };
            Display3DSprite.prototype.setMaterialVc = function ($material, $mp) {
                ...
                me.Scene_data.context3D.setVc4fv($material.shader, "fc", $material.fcData);
            ...
            Display3DSprite.prototype.setMaterialTexture = function ($material, $mp) {
                ...
                for (var i = 0; i < texVec.length; i++) {
                    if (texVec[i].type == me.TexItem.LIGHTMAP) {
                        //_context.setTextureAt(texVec[i].id, lightMapTexture);
                        me.Scene_data.context3D.setRenderTexture($material.shader, texVec[i].name, this.lightMapTexture, texVec[i].id);
                    }
                    else if (texVec[i].type == me.TexItem.LTUMAP && me.Scene_data.pubLut) {
                        me.Scene_data.context3D.setRenderTexture($material.shader, texVec[i].name, me.Scene_data.pubLut, texVec[i].id);
                        //_context.setTextureAt(texVec[i].id, Scene_data.prbLutTexture.texture);
                    }
                    else if (texVec[i].type == me.TexItem.CUBEMAP) {
                        if ($material.useDynamicIBL) { // && _reflectionTextureVo) {
                            ...
                            if (me.Scene_data.skyCubeMap) {
                                var cubeTexture = me.Scene_data.skyCubeMap[index];
                                me.Scene_data.context3D.setRenderTextureCube($material.shader.program, texVec[i].name, cubeTexture, texVec[i].id);
                            }
                        }
                    }
                    ...
                    //}
                        ...
                        if (texVec[i].texture) {
                            me.Scene_data.context3D.setRenderTexture($material.shader, texVec[i].name, texVec[i].texture, texVec[i].id);
                        }
                    }
                }
                if ($mp) {
                    for (i = 0; i < $mp.dynamicTexList.length; i++) {
                        ...
                        if ($mp.dynamicTexList[i].target) {
                            me.Scene_data.context3D.setRenderTexture($material.shader, $mp.dynamicTexList[i].target.name, $mp.dynamicTexList[i].texture, $mp.dynamicTexList[i].target.id);
                        }
                    }
                }
            };
            Display3DSprite.prototype.checkMaterialTexture = function ($material) {
                ...
                for (var i = 0; i < texVec.length; i++) {
                    ...
                    else if (texVec[i].type == me.TexItem.LTUMAP) {
            ...
            Display3DSprite.prototype.updateRotationMatrix = function () {
                try {
                    ...
                    this._rotationMatrix.appendRotation(this._rotationX, me.Vector3D.X_AXIS);
                    this._rotationMatrix.appendRotation(this._rotationY, me.Vector3D.Y_AXIS);
                    this._rotationMatrix.appendRotation(this._rotationZ, me.Vector3D.Z_AXIS);
        ...
        me.Display3DSprite = Display3DSprite;
