    ...
    (function (me) {
        var Display3DLocusPartilce = /** @class */ (function (_super) {
            ...
            Display3DLocusPartilce.prototype.creatData = function () {
                this.data = new me.ParticleLocusData;
            };
            Display3DLocusPartilce.prototype.setVa = function () {
                ...
                if (!tf) {
                    ...
                    me.Scene_data.context3D.setVaOffset(1, 2, this.data.objData.stride, 28);
                    if (this.data._watchEye) {
                        me.Scene_data.context3D.setVaOffset(2, 4, this.data.objData.stride, 12);
                    }
                }
            ...
            Display3DLocusPartilce.prototype.setVc = function () {
                ...
                if (this.data._watchEye) {
                    this.locusdata._caramPosVec[0] = me.Scene_data.cam3D.x;
                    this.locusdata._caramPosVec[1] = me.Scene_data.cam3D.y;
                    this.locusdata._caramPosVec[2] = me.Scene_data.cam3D.z;
            ...
            Display3DLocusPartilce.prototype.updateUV = function () {
                var $nowTime = this._time / me.Scene_data.frameTime;
        ...
        me.Display3DLocusPartilce = Display3DLocusPartilce;
