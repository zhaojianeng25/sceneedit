    ...
    (function (me) {
        var Material = /** @class */ (function (_super) {
            ...
            Material.prototype.updateScene = function () {
                if (this.sceneNumId == me.Scene_data.sceneNumId) {
                    return;
                }
                this.sceneNumId = me.Scene_data.sceneNumId;
                if (this.fogMode != 0) {
                    var idx = this.fcIDAry[1] * 4;
                    this.fcData[0 + idx] = me.Scene_data.fogColor[0];
                    this.fcData[1 + idx] = me.Scene_data.fogColor[1];
                    this.fcData[2 + idx] = me.Scene_data.fogColor[2];
                }
                if (this.scaleLightMap) {
                    var idx = this.fcIDAry[2] * 4;
                    this.fcData[0 + idx] = me.Scene_data.scaleLight[0];
                }
            };
            Material.prototype.initFcData = function () {
                ...
                if (this.hasTime || this.useKill || this.fogMode != 0) { //fc0
                    ...
                    if (this.fogMode != 0) {
                        this.fcData[2] = me.Scene_data.fogData[0];
                        this.fcData[3] = me.Scene_data.fogData[1];
                    }
                }
                if (this.usePbr || this.fogMode == 1) {
                    var idx = this.fcIDAry[0] * 4;
                    this.fcData[0 + idx] = me.Scene_data.cam3D.x / 100;
                    this.fcData[1 + idx] = me.Scene_data.cam3D.y / 100;
                    this.fcData[2 + idx] = me.Scene_data.cam3D.z / 100;
                }
                if (this.fogMode != 0) {
                    var idx = this.fcIDAry[1] * 4;
                    this.fcData[0 + idx] = me.Scene_data.fogColor[0];
            ...
            Material.prototype.setCompileData = function (_compileData) {
                ...
                if (_compileData.constList) {
                    ...
                    for (i = 0; i < ary.length; i++) {
                        var constItem = new me.ConstItem;
            ...
            Material.prototype.readConstLis = function (fs) {
                ...
                for (var i = 0; i < constLisLen; i++) {
                    ...
                    constItem.value = new me.Vector3D(fs.readFloat(), fs.readFloat(), fs.readFloat(), fs.readFloat());
