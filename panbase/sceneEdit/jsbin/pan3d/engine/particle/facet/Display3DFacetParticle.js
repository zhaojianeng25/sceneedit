    ...
    (function (me) {
        var Display3DFacetParticle = /** @class */ (function (_super) {
            ...
            Display3DFacetParticle.prototype.creatData = function () {
                this.data = new me.ParticleFacetData;
            };
            ...
            Display3DFacetParticle.prototype.setVc = function () {
                ...
                this.data.vcmatData.set(me.Scene_data.viewMatrx3D.m, 0);
                ...
                this.data.vcmatData.set(me.Scene_data.cam3D.cameraMatrix.m, 16);
                ...
                this.setMaterialVc();
                if (!this.facetdata._isCycle && this._time / me.Scene_data.frameTime > (this.data._life - 2)) {
                    this._lifeVisible = false;
                }
                me.Scene_data.context3D.setVcMatrix4fv(this.data.materialParam.shader, "vcmat", this.data.vcmatData);
            };
            Display3DFacetParticle.prototype.setVa = function () {
                ...
                if (!tf) {
                    ...
                    me.Scene_data.context3D.setVaOffset(1, 2, this.data.objData.stride, 12);
                }
            ...
            Display3DFacetParticle.prototype.updateUV = function () {
                var currentFrame = float2int(this._time / me.Scene_data.frameTime);
                ...
                this._resultUvVec[0] = float2int(currentFrame % this.data._animLine) / this.data._animLine + this._time / me.Scene_data.frameTime * this.data._uSpeed;
                this._resultUvVec[1] = float2int(currentFrame / this.data._animLine) / this.data._animRow + this._time / me.Scene_data.frameTime * this.data._vSpeed;
            };
            return Display3DFacetParticle;
        }(me.Display3DParticle));
        me.Display3DFacetParticle = Display3DFacetParticle;
