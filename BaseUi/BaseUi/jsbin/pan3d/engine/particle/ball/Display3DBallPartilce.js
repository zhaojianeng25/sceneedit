    ...
    (function (me) {
        var Display3DBallPartilce = /** @class */ (function (_super) {
            ...
            Display3DBallPartilce.prototype.creatData = function () {
                this.data = new me.ParticleBallData;
            };
            Display3DBallPartilce.prototype.setVa = function () {
                ...
                me.Scene_data.context3D.drawCall(this.data.objData.indexBuffer, this.data.objData.treNum);
            };
            Display3DBallPartilce.prototype.setVaCompress = function () {
                var tf = me.Scene_data.context3D.pushVa(this.data.objData.vertexBuffer);
                if (tf) {
                    return;
                }
                me.Scene_data.context3D.setVaOffset(0, 3, this.data.objData.stride, 0);
                me.Scene_data.context3D.setVaOffset(1, 3, this.data.objData.stride, 12);
                me.Scene_data.context3D.setVaOffset(2, 4, this.data.objData.stride, 24);
                me.Scene_data.context3D.setVaOffset(3, 3, this.data.objData.stride, 40);
                if (this.balldata._needSelfRotation) {
                    me.Scene_data.context3D.setVaOffset(4, 2, this.data.objData.stride, 52);
                }
                if (this.balldata._needRandomColor) {
                    me.Scene_data.context3D.setVaOffset(5, 4, this.particleBallData.stride, this.particleBallData.randomOffset);
                }
            };
            ...
            Display3DBallPartilce.prototype.setVc = function () {
                ...
                this.balldata.vcmatData.set(me.Scene_data.viewMatrx3D.m, 0);
                ...
                this.balldata.vcmatData.set(me.Scene_data.cam3D.cameraMatrix.m, 16);
                ...
                this.balldata._timeVec[0] = this._time / me.Scene_data.frameTime * this.balldata._playSpeed;
                ...
                */
                if (this.balldata._is3Dlizi) {
                    ...
                    this.balldata._caramPosVec[0] = me.Scene_data.cam3D.x;
                    this.balldata._caramPosVec[1] = me.Scene_data.cam3D.y;
                    this.balldata._caramPosVec[2] = me.Scene_data.cam3D.z;
                 ...
                 */
                me.Scene_data.context3D.setVcMatrix4fv(this.data.materialParam.shader, "vcmat", this.balldata.vcmatData);
                this.setMaterialVc();
            };
            Display3DBallPartilce.prototype.updateWatchCaramMatrix = function () {
                this._rotationMatrix.identity();
                if (this.balldata.facez) {
                    this._rotationMatrix.prependRotation(90, me.Vector3D.X_AXIS);
                }
                    ...
                    this.timeline.inverAxisRotation(this._rotationMatrix);
                    this.inverBind();
                    this._rotationMatrix.prependRotation(-me.Scene_data.cam3D.rotationY, me.Vector3D.Y_AXIS);
                    this._rotationMatrix.prependRotation(-me.Scene_data.cam3D.rotationX, me.Vector3D.X_AXIS);
                }
            };
            Display3DBallPartilce.prototype.updateAllRotationMatrix = function () {
                ...
                this.timeline.inverAxisRotation(this._rotationMatrix);
                if (this.isInGroup) {
                    this.balldata._allRotationMatrix.appendRotation(this.groupRotation.x, me.Vector3D.X_AXIS);
                    this.balldata._allRotationMatrix.appendRotation(this.groupRotation.y, me.Vector3D.Y_AXIS);
                    this.balldata._allRotationMatrix.appendRotation(this.groupRotation.z, me.Vector3D.Z_AXIS);
                }
                if (this.bindMatrix) {
        ...
        }(me.Display3DParticle));
        me.Display3DBallPartilce = Display3DBallPartilce;
