...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var ArrowEffectBaseVo = /** @class */ (function () {
                function ArrowEffectBaseVo() {
                }
                ArrowEffectBaseVo.prototype.parse = function (data) {
                ...
                return ArrowEffectBaseVo;
            }());
            template.ArrowEffectBaseVo = ArrowEffectBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=ArrowEffectBaseVo.js.map