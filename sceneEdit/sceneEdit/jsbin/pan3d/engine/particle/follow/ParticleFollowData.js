    ...
    (function (me) {
        var ParticleFollowData = /** @class */ (function (_super) {
            ...
            ParticleFollowData.prototype.getParticle = function () {
                return new me.Display3DFollowPartilce;
            };
            ...
            ParticleFollowData.prototype.regShader = function () {
                ...
                this.materialParam.shader = me.ProgrmaManager.getInstance().getMaterialProgram(me.Display3DFollowShader.Display3D_Follow_Shader, me.Display3DFollowShader, this.materialParam.material, shaderParameAry);
                this.materialParam.program = this.materialParam.shader.program;
            };
            return ParticleFollowData;
        }(me.ParticleBallData));
        me.ParticleFollowData = ParticleFollowData;
