    ...
    (function (obj) {
        var BinLogStru = /** @class */ (function (_super) {
            ...
            Object.defineProperty(BinLogStru.prototype, "uint32", {
                ...
                set: function (val) {
                    this._typ = obj.SyncEvent.TYPE_UINT32;
                    //this._value_u32 = val;
            ...
            Object.defineProperty(BinLogStru.prototype, "int32", {
                get: function () {
                    if (this._typ != obj.SyncEvent.TYPE_INT32)
                ...
                set: function (val) {
                    this._typ = obj.SyncEvent.TYPE_INT32;
            ...
            Object.defineProperty(BinLogStru.prototype, "bit", {
                get: function () {
                    if (this._typ != obj.SyncEvent.TYPE_BIT)
                        throw new Error("get bit but _typ != SyncEvent.TYPE_BIT");
                    //return this._value_u32;
                    return this._value_u32_buffer.getUint32(0, true);
                },
                set: function (val) {
                    this._typ = obj.SyncEvent.TYPE_BIT;
                    //this._value_u32 = val;
                    this._value_u32_buffer.setUint32(0, val, true);
                },
                enumerable: true,
            ...
            Object.defineProperty(BinLogStru.prototype, "uint16", {
                get: function () {
                    if (this._typ != obj.SyncEvent.TYPE_UINT16)
                ...
                set: function (val) {
                    this._typ = obj.SyncEvent.TYPE_UINT16;
            ...
            Object.defineProperty(BinLogStru.prototype, "int16", {
                get: function () {
                    if (this._typ != obj.SyncEvent.TYPE_INT16)
                ...
                set: function (val) {
                    this._typ = obj.SyncEvent.TYPE_INT16;
            ...
            Object.defineProperty(BinLogStru.prototype, "byte", {
                get: function () {
                    if (this._typ != obj.SyncEvent.TYPE_UINT8)
                ...
                set: function (val) {
                    this._typ = obj.SyncEvent.TYPE_UINT8;
            ...
            BinLogStru.prototype.Clear = function () {
                ...
                this._typ = 0;
                this._index = 0;
                this._atomic_opt = obj.SyncEvent.ATOMIC_OPT_RESULT_NO;
                //this._value_u32 = 0;
            ...
            BinLogStru.prototype.ReadFrom = function (bytes) {
                ...
                else if (this._typ == obj.SyncEvent.TYPE_DOUBLE) {
