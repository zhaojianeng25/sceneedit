    ...
    (function (me) {
        var SceneQuadTree = /** @class */ (function () {
            ...
            SceneQuadTree.prototype.init = function (obj, $dic) {
                this._circle = new me.Circle(10000, 10000);
                this._sceneDic = $dic;
                this._rootNode = this.getNode(obj);
                this._ray = new me.Ray;
            };
            SceneQuadTree.prototype.getNode = function (obj) {
                var quadNode = new me.QuadTreeNode(obj.x, obj.y, obj.z, obj.width, obj.height, obj.depth);
                if (obj.data) {
                    if (!quadNode.sun) {
                        quadNode.sun = new Array;
                    }
                    for (var i = 0; i < obj.data.length; i++) {
                        var dataNode = new me.QuadTreeNode(obj.data[i].x, obj.data[i].y, obj.data[i].z, obj.data[i].width, obj.data[i].height, obj.data[i].depth);
                        var key;
            ...
            SceneQuadTree.prototype.update = function () {
                ...
                this._ray.setPos(me.Scene_data.cam3D.x, me.Scene_data.cam3D.y, me.Scene_data.cam3D.z);
                this._ray.setTarget(me.Scene_data.focus3D.x, me.Scene_data.focus3D.y, me.Scene_data.focus3D.z);
                this._ray.baseT = me.Scene_data.cam3D.distance;
            ...
            SceneQuadTree.prototype.updateDraw = function () {
                if (this.capsuleLineSprite) {
                    this.capsuleLineSprite.x = me.Scene_data.focus3D.x;
                    this.capsuleLineSprite.y = me.Scene_data.focus3D.y + 50;
                    this.capsuleLineSprite.z = me.Scene_data.focus3D.z;
        ...
        me.SceneQuadTree = SceneQuadTree;
