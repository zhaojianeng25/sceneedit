...
(function (Pan3d) {
    var TextJumpType = /** @class */ (function () {
        ...
        TextJumpType.DEFENSEADD = 16; //防御增加
        TextJumpType.DEFENSEREDUCE = 17; //防御减少
        TextJumpType.POISONING = 18; //中毒
        TextJumpType.IMMUNE = 19; //免疫
        TextJumpType.RESISTANCE = 20; //抵抗
        return TextJumpType;
    }());
    ...
    var CharTitleUiVo = /** @class */ (function (_super) {
        ...
        CharTitleUiVo.prototype.makeData = function () {
            ...
            if (this._data) {
                ...
                if (this._charTitleMeshVo.num == "")
                    return;
                if (this.lastKey != this._charTitleMeshVo.num) {
                    this.ui.width = 100;
                    this.ui.height = 50;
                    this.lastKey = this._charTitleMeshVo.num;
                    Pan3d.LabelTextFont.writeSingleLabel(this.parent.uiAtlas, this.textureStr, this._charTitleMeshVo.num, 18, Pan3d.TextAlign.CENTER, "#ffffff", "#27262e");
                }
