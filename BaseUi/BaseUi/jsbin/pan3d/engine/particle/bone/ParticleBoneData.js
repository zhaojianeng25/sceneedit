    ...
    (function (me) {
        var ParticleBoneData = /** @class */ (function (_super) {
            ...
            ParticleBoneData.prototype.getParticle = function () {
                return new me.Display3DBonePartilce();
            };
            ...
            ParticleBoneData.prototype.setAllByteInfo = function ($byte) {
                this.meshData = new me.MeshData();
                this.animData = new me.AnimData();
                ...
                me.BaseRes.readBytes2ArrayBuffer($byte, data, 2, 3, dataWidth); //uvs
                me.BaseRes.readIntForTwoByte($byte, this.meshData.indexs);
                me.BaseRes.readBytes2ArrayBuffer($byte, data, 4, 5, dataWidth, 2); //boneIDAry
                me.BaseRes.readBytes2ArrayBuffer($byte, data, 4, 9, dataWidth, 3); //boneWeightAry
                ...
                //this.uploadGpu();
                this.initVcData();
                this.meshData.vertexBuffer = me.Scene_data.context3D.uploadBuff3DArrayBuffer(arybuff);
                this.meshData.indexBuffer = me.Scene_data.context3D.uploadIndexBuff3D(this.meshData.indexs);
                this.meshData.treNum = this.meshData.indexs.length;
            };
            ParticleBoneData.prototype.initVcData = function () {
                this.vcmatData = new Float32Array(me.Display3DBoneShader.getVcSize() * 16);
            };
            ParticleBoneData.prototype.setFloat32Mat = function (key, ary) {
                var idx = me.Display3DBoneShader.shader_mat4[key] * 16;
            ...
            ParticleBoneData.prototype.readFrameQua = function ($byte) {
                ...
                for (var i = 0; i < $frameNum; i++) {
                    ...
                    var $DualQuatFloat32Array = new me.DualQuatFloat32Array;
            ...
            ParticleBoneData.prototype.regShader = function () {
                this.materialParam.shader = me.ProgrmaManager.getInstance().getMaterialProgram(me.Display3DBoneShader.Display3DBoneShader, me.Display3DBoneShader, this.materialParam.material);
                this.materialParam.program = this.materialParam.shader.program;
            };
            return ParticleBoneData;
        }(me.ParticleData));
        me.ParticleBoneData = ParticleBoneData;
