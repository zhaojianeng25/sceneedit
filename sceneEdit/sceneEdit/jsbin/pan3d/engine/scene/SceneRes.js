        ...
        var SceneRes = /** @class */ (function (_super) {
            ...
            SceneRes.prototype.load = function ($url, $completeFun, $progressFun, $readDataFun) {
                ...
                if (config && config[$url]) {
                    ...
                    $url = me.Scene_data.fileRoot + getMapUrl($url);
            ...
            SceneRes.prototype.loadZipMap = function (name, size) {
                ...
                for (var i = 0; i < size; i++) {
                    ...
                    var url = me.Scene_data.fileRoot + getZipMapUrl(name) + i + ".txt";
                    xhrList.push(xhr);
            ...
            SceneRes.prototype.isNeedReload = function () {
                ...
                for (var i = 0; i < ary.length; i++) {
                    if (ary[i].type == me.BaseRes.PREFAB_TYPE && ary[i].lighturl) {
                        var url = me.Scene_data.fileRoot + ary[i].lighturl;
                        if (me.TextureManager.getInstance().hasTexture(url)) {
                            return false;
                        }
                        else {
                            return true;
                ...
                return ((me.ResCount.GCTime - this.idleTime) < 10);
            };
            ...
            SceneRes.prototype.readTerrainIdInfoBitmapData = function ($byte) {
                ...
                if ($len) {
                    ...
                    this._terrainDataItem = me.GroundDataMesh.meshAllgroundData(newByte);
                }
            };
            SceneRes.prototype.readAstat = function () {
                ...
                if (hasAstat) {
                    ...
                    this._astarDataMesh.aPos = new me.Vector3D;
