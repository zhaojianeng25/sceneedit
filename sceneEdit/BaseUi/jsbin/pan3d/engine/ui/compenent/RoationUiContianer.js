...
(function (Pan3d) {
    ...
    (function (me) {
        ...
        me.RoationUIShader = RoationUIShader;
        var RoationUIRenderComponent = /** @class */ (function (_super) {
            ...
            RoationUIRenderComponent.prototype.initData = function () {
                ...
                me.ProgrmaManager.getInstance().registe(RoationUIShader.RoationUiShader, new RoationUIShader);
                this.shader = me.ProgrmaManager.getInstance().getProgram(RoationUIShader.RoationUiShader);
                ...
                this.alphaLocation = me.Scene_data.context3D.getLocation(this.program, "rotation");
            };
        ...
        var RoationUICompenent = /** @class */ (function (_super) {
            ...
            function RoationUICompenent() {
                ...
                _this.paix = new me.Vector2D(0, 0);
                return _this;
            }
            RoationUICompenent.prototype.setVc = function (program, index) {
                this.rotation += this.aotuRotation;
                me.Scene_data.context3D.setVc4fv(program, "ui[" + index + "]", this.renderData);
                me.Scene_data.context3D.setVc4fv(program, "ui2[" + index + "]", this.renderData2);
                me.Scene_data.context3D.setVc2fv(program, "paix[" + index + "]", [this.paix.x, this.paix.y]);
                me.Scene_data.context3D.setVc1fv(program, "rotation[" + index + "]", [this.rotation * Math.PI / 180]);
                me.Scene_data.context3D.setVc1fv(program, "sc", [me.Scene_data.stageWidth / me.Scene_data.stageHeight]);
            };
