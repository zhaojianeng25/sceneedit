...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var ActivityNewpayBaseVo = /** @class */ (function () {
                function ActivityNewpayBaseVo() {
                }
                ActivityNewpayBaseVo.prototype.parse = function (data) {
                ...
                return ActivityNewpayBaseVo;
            }());
            template.ActivityNewpayBaseVo = ActivityNewpayBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=ActivityNewpayBaseVo.js.map