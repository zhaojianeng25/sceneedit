    ...
    (function (me) {
        var Display3DFollowPartilce = /** @class */ (function (_super) {
            ...
            Display3DFollowPartilce.prototype.creatData = function () {
                this.data = new me.ParticleFollowData;
            };
            ...
            Display3DFollowPartilce.prototype.setVc = function () {
                ...
                // }
                me.Scene_data.context3D.setVc3fv(this.data.materialParam.shader, "bindpos", this._bindMatrixAry);
            };
            ...
            Display3DFollowPartilce.prototype.updateBind = function () {
                var time = this._time / me.Scene_data.frameTime;
            ...
            Display3DFollowPartilce.prototype.updateAllRotationMatrix = function () {
                ...
                if (this.isInGroup) {
                    this.followdata._allRotationMatrix.appendRotation(this.groupRotation.x, me.Vector3D.X_AXIS);
                    this.followdata._allRotationMatrix.appendRotation(this.groupRotation.y, me.Vector3D.Y_AXIS);
                    this.followdata._allRotationMatrix.appendRotation(this.groupRotation.z, me.Vector3D.Z_AXIS);
                }
            };
        ...
        me.Display3DFollowPartilce = Display3DFollowPartilce;
