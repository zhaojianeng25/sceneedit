...
(function (game) {
    ...
    (function (modules) {
        ...
        (function (strengThening) {
            var StrengTheningFixViewMediator = /** @class */ (function (_super) {
                __extends(StrengTheningFixViewMediator, _super);
                function StrengTheningFixViewMediator(uiLayer, app) {
                    ...
                    _this.bgBtn = null;
                    _this._viewUI = new ui.common.StrengTheningFixUI();
                    _this.isCenter = false;
                    _this._app = app;
                    _this.initLists();
                    _this._viewUI.tishi_label.visible = false;
                    _this._viewUI.fix_btn.on(LEvent.MOUSE_DOWN, _this, _this.onFixBtn);
                    _this._viewUI.addMoney_btn.on(LEvent.MOUSE_DOWN, _this, _this.addMoney);
                    _this._viewUI.isUse_check.on(LEvent.MOUSE_DOWN, _this, _this.onUseCheckBox);
                    ...
                    game.modules.bag.models.BagProxy.getInstance().on(game.modules.bag.models.ITEMADD_OR_DEL, _this, _this.initLists);
                    return _this;
                }
                /**显示兑换银币界面 */
                StrengTheningFixViewMediator.prototype.addMoney = function () {
                ...
                /**初始化数据 */
                StrengTheningFixViewMediator.prototype.initLists = function () {
                    this.initHaveEqu();
                ...
                /**显示装备 */
                StrengTheningFixViewMediator.prototype.equipRender = function (equArr, cell, index) {
                ...
                /**列表点击效果 */
                StrengTheningFixViewMediator.prototype.onEquipBtn = function (index, cell) {
                    var bgBtn = cell.getChildByName("equip_btn");
                    bgBtn.selected = true;
                    if (this.bgBtn == null) {
                        this.bgBtn = cell;
                        return;
                    ...
                    if (this.bgBtn != cell) {
                        var equip_btn = this.bgBtn.getChildByName("equip_btn");
                        equip_btn.selected = false;
                        this.bgBtn = cell;
                    }
                };
                /**装备是否能装备 */
                StrengTheningFixViewMediator.prototype.equipIsCanWear = function (itemId) {
                    var iscanWear = false;
                ...
                /**选择装备 */
                StrengTheningFixViewMediator.prototype.equipListSelect = function (index) {
                ...
                /**获取材料 */
                StrengTheningFixViewMediator.prototype.getCailiao = function (commonidlist, commonnumlist) {
                    var arr = [];
                 ...
                 * 显示装备属性list
                 */
                StrengTheningFixViewMediator.prototype.attributeList = function (equId) {
                    var packid = 0;
                    var keyinpack = 0;
                    var curEquipTips = [];
                 ...
                 * 修改装备属性label颜色
                 */
                StrengTheningFixViewMediator.prototype.attributeListRender = function (arr, cell, index) {
                    var label = cell.getChildByName("attribute_label");
                ...
                /**显示列表 */
                StrengTheningFixViewMediator.prototype.showList = function (list, arr) {
                    list.vScrollBarSkin = "";
                 ...
                 * 改变显示材料数量label颜色
                 */
                StrengTheningFixViewMediator.prototype.showNeedNum = function (needNum, haveNum, label, isMoney) {
                    if (isMoney) {
                        label.text = needNum + "";
                        if (haveNum >= needNum) {
                            label.color = "#FFF2DF";
                 ...
                 * 修理按钮
                 */
                StrengTheningFixViewMediator.prototype.onFixBtn = function () {
                    var packid = 0;
                    var keyinpack = 0;
                ...
                /**获取物品的key */
                StrengTheningFixViewMediator.prototype.getKey = function (bag, equId) {
                ...
                /**是否使用强化剂 */
                StrengTheningFixViewMediator.prototype.onUseCheckBox = function () {
                    if (!this._viewUI.isUse_check.selected) {
                ...
                /**点击物品 显示详情*/
                StrengTheningFixViewMediator.prototype.onItemBtn = function (itemId) {
                ...
                /**显示物品的获取途径 */
                StrengTheningFixViewMediator.prototype.showComefrom = function (equipid) {
                ...
                /**修理异常返回 */
                StrengTheningFixViewMediator.prototype.showError = function (errorCode) {
                ...
                /**获取拥有的装备id  宝石id */
                StrengTheningFixViewMediator.prototype.initHaveEqu = function () {
                    this.m_haveEqu = [];
                ...
                /**获取背包数据 */
                StrengTheningFixViewMediator.prototype.getItems = function (bag) {
                    var idArr = [];
                ...
                /**将背包中的物品分类 */
                StrengTheningFixViewMediator.prototype.pushToArr = function (returnBag, packid) {
                ...
                StrengTheningFixViewMediator.prototype.show = function () {
                    this.initHaveEqu();
                    _super.prototype.show.call(this);
                    //console.log("LoginViewMediator show");
                };
                StrengTheningFixViewMediator.prototype.hide = function () {
                    _super.prototype.hide.call(this);
                };
                StrengTheningFixViewMediator.prototype.getView = function () {
                    return this._viewUI;
                };
                return StrengTheningFixViewMediator;
            }(game.modules.UiMediator));
            strengThening.StrengTheningFixViewMediator = StrengTheningFixViewMediator;
        })(strengThening = modules.strengThening || (modules.strengThening = {}));
    })(modules = game.modules || (game.modules = {}));
})(game || (game = {}));
//# sourceMappingURL=StrengTheningFixViewMediator.js.map