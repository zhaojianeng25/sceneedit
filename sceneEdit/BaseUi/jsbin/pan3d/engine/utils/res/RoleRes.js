        ...
        var RoleRes = /** @class */ (function (_super) {
            ...
            RoleRes.prototype.readMesh = function () {
                ...
                if (this.version >= 16) { //环境参数
                    this.ambientLightColor = new me.Vector3D;
                    this.sunLigthColor = new me.Vector3D;
                    this.nrmDircet = new me.Vector3D;
                ...
                me.MeshDataManager.getInstance().readData(this._byte, this.meshBatchNum, this.roleUrl, this.version);
                this.readAction();
            };
            RoleRes.prototype.readAction = function () {
                ...
                for (var i = 0; i < actionNum; i++) {
                    ...
                    me.AnimManager.getInstance().readData($actionByte, this.roleUrl + actionName);
