    ...
    (function (me) {
        var QuadTreeNode = /** @class */ (function () {
            ...
            QuadTreeNode.prototype.testViewFrustumResult = function (face) {
                var pos = new me.Vector3D(this.x, this.y, this.z);
                var whd = new me.Vector3D(this.width, this.height, this.depth);
                var bInSide = true;
        ...
        me.QuadTreeNode = QuadTreeNode;
        var Ray = /** @class */ (function () {
            function Ray() {
                this.o = new me.Vector3D;
                this.d = new me.Vector3D;
                this.baseT = 500;
            }
