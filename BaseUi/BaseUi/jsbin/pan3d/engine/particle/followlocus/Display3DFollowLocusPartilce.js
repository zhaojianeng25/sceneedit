    ...
    (function (me) {
        var Display3DFollowLocusPartilce = /** @class */ (function (_super) {
            ...
            Display3DFollowLocusPartilce.prototype.creatData = function () {
                this.data = new me.ParticleFollowLocusData;
            };
            ...
            Display3DFollowLocusPartilce.prototype.setVc = function () {
                ...
                this._caramPosVec[0] = me.Scene_data.cam3D.x;
                this._caramPosVec[1] = me.Scene_data.cam3D.y;
                this._caramPosVec[2] = me.Scene_data.cam3D.z;
            ...
            Display3DFollowLocusPartilce.prototype.setBindPosVc = function () {
                for (var i = 0; i < this._bindPosAry.length; i++) {
                    me.Scene_data.context3D.setVc3fv(this.data.materialParam.shader, "bindpos[" + i + "]", this._bindPosAry[i]);
                }
            };
            ...
            Display3DFollowLocusPartilce.prototype.resetPos = function () {
                ...
                this.flag = me.TimeUtil.getTimer();
            };
            Display3DFollowLocusPartilce.prototype.updateBind = function () {
                var ctime = me.TimeUtil.getTimer();
                if ((ctime - this.flag) >= Display3DFollowLocusPartilce.waitCdTime) {
                    ...
                    var v3d = new me.Vector3D(pos[0] - pos0[0], pos[1] - pos0[1], pos[2] - pos0[2]);
                    v3d.normalize();
                    normal0[0] = v3d.x;
                    normal[0] = v3d.x;
                    normal0[1] = v3d.y;
        ...
        me.Display3DFollowLocusPartilce = Display3DFollowLocusPartilce;
