...
(function (game) {
     ...
     * 沙尘暴
     */
        var WeatherSandstorms = /** @class */ (function (_super) {
            __extends(WeatherSandstorms, _super);
            function WeatherSandstorms(app) {
                var _this = _super.call(this, app) || this;
                _this._assetsLoader = new AssetsLoader();
                _this._assetsLoader.load([game.Path.atlas_scene + "weather/sandstorms.atlas"], Handler.create(_this, _this.onResComplete));
                return _this;
            }
            WeatherSandstorms.prototype.onResComplete = function () {
                var path = 'scene/weather/sandstorms/';
             ...
             * @return 重置是否成功
             */
            WeatherSandstorms.prototype.onReset = function (camera) {
            ...
            /**设置素材显示数量*/
            WeatherSandstorms.prototype.setTextureLens = function () {
            ...
            WeatherSandstorms.prototype.getInitInfo = function (camera, idxT, idxC) {
            ...
            WeatherSandstorms.prototype.setQuadStartPos = function (quadID, x, y, rnd, disance) {
            ...
            WeatherSandstorms.prototype.onUpdate = function (scene, g) {
                if (!this.isEnable) {
                    return;
                }
            ...
            WeatherSandstorms.prototype.clear = function () {
                this._assetsLoader.clear();
                _super.prototype.clear.call(this);
            };
            return WeatherSandstorms;
        }(scene_1.WeatherBase));
        scene_1.WeatherSandstorms = WeatherSandstorms;
    })(scene = game.scene || (game.scene = {}));
})(game || (game = {}));
//# sourceMappingURL=WeatherSandstorms.js.map