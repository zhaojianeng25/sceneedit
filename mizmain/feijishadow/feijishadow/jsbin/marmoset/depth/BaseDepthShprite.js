...
(function (depth) {
    ...
    depth.MarFBO = MarFBO;
    var BaseDepthShader = /** @class */ (function (_super) {
        __extends(BaseDepthShader, _super);
        function BaseDepthShader() {
            return _super.call(this) || this;
        }
        BaseDepthShader.prototype.binLocation = function ($context) {
            $context.bindAttribLocation(this.program, 0, "vPosition");
            $context.bindAttribLocation(this.program, 1, "u2Texture");
        };
        BaseDepthShader.prototype.getVertexShaderString = function () {
        ...
        BaseDepthShader.prototype.getFragmentShaderString = function () {
        ...
        BaseDepthShader.BaseDepthShader = "BaseDepthShader";
        return BaseDepthShader;
    }(Shader3D));
    depth.BaseDepthShader = BaseDepthShader;
    var BaseDepthSprite = /** @class */ (function () {
        function BaseDepthSprite() {
            ...
            ProgrmaManager.getInstance().registe(BaseDepthShader.BaseDepthShader, new BaseDepthShader);
            this.shader = ProgrmaManager.getInstance().getProgram(BaseDepthShader.BaseDepthShader);
        ...
        BaseDepthSprite.prototype.updateDepthTexture = function (fbo) {
            var gl = Scene_data.context3D.renderContext;
        ...
        BaseDepthSprite.prototype.update = function () {
            var gl = Scene_data.context3D.renderContext;
        ...
        return BaseDepthSprite;
    }());
    depth.BaseDepthSprite = BaseDepthSprite;
})(depth || (depth = {}));
//# sourceMappingURL=BaseDepthShprite.js.map