    ...
    (function (me) {
        var CombineParticle = /** @class */ (function (_super) {
            ...
            function CombineParticle() {
                ...
                _this._time = 0;
                _this.bindMatrix = new me.Matrix3D;
                _this.invertBindMatrix = new me.Matrix3D;
                _this.bindVecter3d = new me.Vector3D();
                _this.bindScale = new me.Vector3D(1, 1, 1);
                _this.groupMatrix = new me.Matrix3D();
                _this.groupRotationMatrix = new me.Matrix3D();
                return _this;
            ...
            CombineParticle.prototype.applyRotation = function () {
                ...
                this.bindMatrix.appendRotation(this._rotationX, me.Vector3D.X_AXIS);
                this.bindMatrix.appendRotation(this._rotationY, me.Vector3D.Y_AXIS);
                this.bindMatrix.appendRotation(this._rotationZ, me.Vector3D.Z_AXIS);
            ...
            CombineParticle.prototype.setDataByte = function (byte) {
                ...
                this._maxTime *= me.Scene_data.frameTime;
            };
            ...
            CombineParticle.prototype.getDisplay3D = function (obj) {
                ...
                switch (types) {
                    case 1:
                        {
                            display3D = new me.Display3DFacetParticle();
                            break;
                        }
                    case 18:
                        {
                            display3D = new me.Display3DBallPartilce();
                            break;
                        }
                    case 3:
                        {
                            display3D = new me.Display3DLocusPartilce();
                            break;
                        }
                    case 14:
                        {
                            display3D = new me.Display3DLocusBallPartilce();
                            break;
                        }
                    case 9:
                        {
                            display3D = new me.Display3DModelObjParticle();
                            break;
                        }
                    case 4:
                        {
                            display3D = new me.Display3DModelPartilce();
                            break;
                        }
                    case 7:
                        {
                            display3D = new me.Display3dModelAnimParticle();
                            break;
                        }
                    case 8:
                        {
                            display3D = new me.Display3DFollowPartilce();
                            break;
                        }
                    // case 12:
                    //     {
        ...
        me.CombineParticle = CombineParticle;
