...
(function (Pan3d) {
    ...
    (function (me) {
            ...
            SkillFixEffect.prototype.addToRender = function () {
                ...
                if (this.outPos) {
                    ...
                    */
                    ...
                    $SkillBugBind.bindMatrix = new me.Matrix3D;
                    $SkillBugBind.bindMatrix.appendRotation(this.rotation.x, me.Vector3D.X_AXIS);
                    $SkillBugBind.bindMatrix.appendRotation(this.rotation.y, me.Vector3D.Y_AXIS);
                    $SkillBugBind.bindMatrix.appendRotation(this.rotation.z, me.Vector3D.Z_AXIS);
                    $SkillBugBind.bindMatrix.appendRotation(this.active.rotationY, me.Vector3D.Y_AXIS);
        ...
        me.SkillFixEffect = SkillFixEffect;
