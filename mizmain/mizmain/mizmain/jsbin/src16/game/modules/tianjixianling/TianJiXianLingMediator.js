...
var AnYeTaskVo = game.modules.tianjixianling.models.AnYeTaskVo;
var game;
(function (game) {
    var modules;
    (function (modules) {
        ...
        (function (tianjixianling) {
            /** 天机仙令主界面 */
            var TianJiXianLingMediator = /** @class */ (function (_super) {
                __extends(TianJiXianLingMediator, _super);
                function TianJiXianLingMediator(app) {
                    var _this = _super.call(this, app.uiRoot.general) || this;
                    /** 天机仙令随机任务配置数据 */
                    _this._tjxlConfigData = {};
                    /** 用于判断是否元宝不足 */
                    _this._isEnough = false;
                    _this._viewUI = new ui.common.TianXianJiLingUI();
                    _this._clientWidth = app.clientWidth;
                    _this._clientHeight = app.clientHeight;
                    _this._app = app;
                    _this._tjxlConfigData = tianjixianling.models.TianJiXianLingModel._instance.tjxlConfig;
                    _this._shapeData = modules.createrole.models.LoginModel.getInstance().cnpcShapeInfo;
                    _this._itemAttrData = modules.bag.models.BagModel._instance.itemAttrData;
                    _this._petInfoData = modules.pet.models.PetModel._instance.petCPetAttrData;
                    _this._NPCConfigData = modules.mainhud.models.HudModel.getInstance().cNPCConfigData;
                    return _this;
                }
                /**
                 * UI界面的初始化
                 */
                TianJiXianLingMediator.prototype._initUI = function () {
                    //部分UI初始化
                    /** 天机仙令随机任务累积完成次数 */
                    var _taskCount = this._tjxlInfoData.times;
                    /** 临时计数 */
                    var _num = Math.ceil(_taskCount / 8); //计算的是天机仙令任务当前处于的轮数值
                 ...
                 * 渲染天机仙令随机任务列表
                 */
                TianJiXianLingMediator.prototype.onRenderTasksLst = function (cell, index) {
                    if (index < 0 || index >= this._anyetasks.length) {
                        return;
                    }
                    /** 任务按钮 */
                    var rw_btn = cell.getChildByName("rw_btn");
                    /** 任务id */
                    var rwId = this._anyetasks[index]["id"];
                    /** 任务名字 */
                    var _strtasknameui = this._tjxlConfigData[rwId]["strtasknameui"];
                    /** 任务名字文本 */
                    var rwName_lab = rw_btn.getChildByName("rwName_lab");
                    rwName_lab.text = _strtasknameui;
                    /** 任务小图标 */
                    var rwIcon_img = rw_btn.getChildByName("rwIcon_img");
                    /** 任务小图标索引id */
                    var _strtasktypeicon = this._tjxlConfigData[rwId]["strtasktypeicon"];
                    rwIcon_img.skin = "common/icon/item/" + _strtasktypeicon + ".png";
                    /** 任务图片（显示目标的图标） */
                    var RenWuItem_img = rw_btn.getChildByName("RenWuItem_img");
                    /** 探索按钮 */
                    var explore_btn = cell.getChildByName("explore_btn");
                    /** 边框图片 */
                    var frame_img = rw_btn.getChildByName("frame_img");
                    /** 任务类型 */
                    ...
                    /** 任务的简单描述的富文本框 */
                    var renwuDesc_htm = rw_btn.getChildByName("renwuDesc_htm");
                    /** 目标的数量 */
                    ...
                    /** 任务状态图片 */
                    var rwState_img = rw_btn.getChildByName("rwState_img");
                 ...
                 * @param index 任务栏位
                 */
                TianJiXianLingMediator.prototype.goToExplore = function (index) {
                    this._taskPos = index;
                    //先判断是否有任务正处于探索的状态下
                    /** 处于探索的状态下的任务栏位 */
                    var _legendpos = tianjixianling.models.TianJiXianLingModel._instance.tjxlInfoData.legendpos;
                    if (_legendpos < 0 || _legendpos > 7) { //如果当前并无正在探索的任务
                        ...
                        modules.tips.models.TipsProxy.getInstance().once(modules.tips.models.TIPS_ON_OK, this, this.sureOnOK);
                    }
                };
                /**
                 * 跳转到探索地图
                 ...
                 */
                TianJiXianLingMediator.prototype.goToExploreMap = function () {
                    ...
                    /** 所要探索的地图id */
                    var _mapId = tianjixianling.models.TianJiXianLingModel._instance.getExploreTaskMapId(this._taskPos);
                    //对当前场景进行判断
                 ...
                 */
                TianJiXianLingMediator.prototype.showTaskDetailInfo = function (index) {
                    this._pos = index;
                    /** 任务id */
                    var rwId = this._anyetasks[index]["id"];
                    /** 任务小图标索引id */
                 ...
                 */
                TianJiXianLingMediator.prototype.reSetUI = function (state, legend, btn, img, index) {
                    if (state == TaskState.SUCCESS) { //当任务成功，按钮隐藏，图片（完成的图片）显示
                        ...
                        if (!btn.name) {
                            ...
                            //任务类型
                            var _taskType = this._anyetasks[index]["kind"];
                            //目标id
                            var _id = this._anyetasks[index]["dstitemid"];
                            //目标数量
                            var _ownedTargetNum = 0;
                            if (_taskType == TaskType.Item) {
                                ...
                                _ownedTargetNum = tianjixianling.models.TianJiXianLingModel.getInstance().checkOwnPetNum(_id); //获取该宠物的拥有数量
                            }
                 ...
                 * 提交目标（道具、装备、宠物等）
                 */
                TianJiXianLingMediator.prototype.submitTarget = function () {
                    /** 任务类型 */
                    ...
                    tianjixianling.models.TianJiXianLingModel.getInstance().submitTarget(itemid, _taskId, this._app, this._viewUI);
                };
                /**
                 * 显示不同的状态下的图片
                 * @param legend 探索状态
                 ...
                 * @param btn 可能要被要重新设置的按钮
                 */
                TianJiXianLingMediator.prototype.showStateImg = function (legend, img, btn) {
                    switch (legend) {
                 ...
                 * 显示奖励道具列表
                 */
                TianJiXianLingMediator.prototype.showJiangLiItemLst = function () {
                 ...
                 * 渲染奖励道具列表
                 */
                TianJiXianLingMediator.prototype.onJiangLiItemLst = function (cell, index) {
                    /** 奖励道具的图片 */
                    var JiangLiItem_img = cell.getChildByName("JiangLiItem_img");
                    /** 奖励道具的id */
                    var JLitemImgId = this._vrewardid[index];
                    JiangLiItem_img.skin = "common/icon/item/" + this._itemAttrData[JLitemImgId]["icon"] + ".png";
                    /** 边框图片 */
                    var frame_img = cell.getChildByName("frame_img");
                    /** 道具的品质色 */
                 ...
                 * 显示道具描述
                 */
                TianJiXianLingMediator.prototype.showItemDesc = function (index) {
                    /** 道具的id */
                 ...
                 */
                TianJiXianLingMediator.prototype.showDesc = function (taskid, tasktype, dstitemid, dstitemnum, dstnpcid, flag) {
                    //如果任务id、任务类型、目标id和目标的数量都没有有效值，直接返回空
                    if (!taskid && !tasktype && !dstitemid && !dstitemnum)
                        return null;
                    /** 任务描述 */
                    var _desc;
                    if (flag) {
                    ...
                    switch (tasktype) { //根据任务类型的不同
                        ...
                        case TaskType.Pet:
                            ...
                            ownedTargetNum = tianjixianling.models.TianJiXianLingModel.getInstance().checkOwnPetNum(dstitemid); //获取该宠物的拥有数量
                            //参数替换
                 ...
                 */
                TianJiXianLingMediator.prototype.showGoalImg = function (tasktype, dstitemid, dstnpcid) {
                    //如果任务类型、目标id和目标NPC的id都没有有效值，直接返回空
                    if (!tasktype && !dstitemid && !dstnpcid)
                        return null;
                    /** 图片id */
                    var imgId;
                    /** 图片路径地址 */
                ...
                TianJiXianLingMediator.prototype.show = function () {
                 ...
                 * 注册事件
                 */
                TianJiXianLingMediator.prototype.registerEvent = function () {
                    //按钮UI事件监听
                    ...
                    //消息监听
                    tianjixianling.models.TianJiXianLingProxy.getInstance().on(tianjixianling.models.GET_TIANJIXIANLING_DATA, this, this.onRefreshData);
                    tianjixianling.models.TianJiXianLingProxy.getInstance().on(tianjixianling.models.ALREADY_JOIN_TJXL, this, this.onRefreshData);
                    tianjixianling.models.TianJiXianLingProxy.getInstance().on(tianjixianling.models.OPEN_EXPLORE_MODE, this, this.goToExploreMap);
                };
                /**
                 * 点击提示窗口的确定，放弃当前正探索的任务，开启另一个任务的探索
                 */
                TianJiXianLingMediator.prototype.sureOnOK = function () {
                    if (this._isEnough) {
                 ...
                 */
                TianJiXianLingMediator.prototype.carryOutProgram = function () {
                    var inTeamGroup = HudModel.getInstance().chargeInGroup();
                    if (inTeamGroup) //处于组队
                     {
                        this._showInTeamTips();
                    ...
                    switch (_tasktype) {
                        case TaskType.Item: //与道具相关
                            ...
                            /** 临时商店类型 */
                            var tempShopType = tianjixianling.models.TianJiXianLingModel.getInstance().getShopType(_itemId);
                            //获取售卖道具相应NPC所在地图id
                 ...
                 * 显示提示飘窗消息
                 */
                TianJiXianLingMediator.prototype.showTipsMsg = function (msg) {
                 ...
                 * 隐藏某些UI
                 */
                TianJiXianLingMediator.prototype.hideUI = function () {
                 ...
                 * @param btn 按钮
                 */
                TianJiXianLingMediator.prototype.showMethodLst = function (btn) {
                 ...
                 * 渲染方法列表
                 */
                TianJiXianLingMediator.prototype.onMethodLst = function (cell, index) {
                    /** 方法按钮 */
                    var method_btn = cell.getChildByName("method_btn");
                    /** 方法文本 */
                    var method_lab = method_btn.getChildByName("method_lab");
                 ...
                 * @param btn 被点击的按钮
                 */
                TianJiXianLingMediator.prototype.checkFactor = function (btn) {
                    //隐藏方法按钮列表
                    this._viewUI.method_lst.visible = false;
                    /** 被点击按钮的文本 */
                    var method_lab = btn.getChildByName("method_lab");
                    /** 文本内容 */
                    var _labText = method_lab.text;
                    switch (_labText) {
                        case "5000金币完成":
                            /** 金币数量 */
                            var _globalIcon = game.modules.mainhud.models.HudModel._instance.goldNum;
                            //先检查背包是否有足够的金币
                            if (_globalIcon >= 5000) {
                                ...
                                /** 金币兑换界面使用元宝兑换 */
                                this._jinBiBuZuViewMediator.once(modules.commonUI.USE_YUANBAO_EXCHANGE_EVENT, this, this._exchange, [Math.ceil((5000 - _globalIcon) / 100)]);
                            }
                            break;
                        case "800声望完成":
                            // /** 声望值 */
                        ...
                        case "全服求助":
                            ...
                            /** 角色基本数据 */
                            var _roleBasicData = _rolelist.get(game.modules.createrole.models.LoginModel.getInstance().roleDetail.roleid);
                            /** 队伍信息数据 */
                            var _teaminfo = _roleBasicData.rolebasicOctets.datas.get(2);
                            if (!_teaminfo) { //如果没有创建队伍
                                modules.team.models.TeamProxy.getInstance().once(modules.team.models.CREATE_TEAM_SUCC, this, this.sendHelpRequest, [helpData]);
                                //先创建一个队伍
                        ...
                        case "帮派求助":
                            ...
                            if (_clankey > 0) { //如果有帮派，就会有帮派id，值就是大于0
                                ...
                                //判断是否时挑战类型的天机仙令随机任务
                                if (this._anyetasks[this._pos].kind != TaskType.NPC) {
                                    this.sendHelpRequest(helpData_1);
                                    break;
                                }
                                /** 角色基本数据 */
                                ...
                                //还需要判断是否有队伍
                                if (!_teaminfo) { //如果没有创建队伍
                                    modules.team.models.TeamProxy.getInstance().once(modules.team.models.CREATE_TEAM_SUCC, this, this.sendHelpRequest, [helpData_1]);
                                    //先创建一个队伍
                                    RequesterProtocols._instance.c2s_CCreateTeam();
                                }
                                else { //要是有了队伍的话
                 ...
                 */
                TianJiXianLingMediator.prototype.sendHelpRequest = function (helpData) {
                    var type1 = helpData[0].type1; //聊天频道类型
                    var msg = helpData[0].msg; //求助信息
                    var noMsg = helpData[0].noMsg; //屏蔽了非法字符后的求助信息
                    var type2 = helpData[0].type2; //聊天消息的功能类型
                    var taskPos = helpData[0].taskPos; //在8个天机仙令中的任务位置
                 ...
                 * 仙晶(元宝)兑换
                 */
                TianJiXianLingMediator.prototype._exchange = function (yuanbao) {
                 ...
                 * 屏蔽非法字符
                 */
                TianJiXianLingMediator.prototype.shieldIllegalCharacter = function (text) {
                    ...
                    /** 存放该被屏蔽字的数组 */
                    var _shield_word = [];
                    for (var i_1 = 0; i_1 < _dicKeys.length; i_1++) {
                        _shield_word.push(_chatConfigBinDic[_dicKeys[i_1]]);
                    }
                    for (var i = 0; i < _shield_word.length; i++) {
                        var index = text.search(_shield_word[i]);
                        if (index != -1) {
                 ...
                 */
                TianJiXianLingMediator.prototype.setHelpMessage = function () {
                    var _helpMessage = "";
                    /** 任务名字 */
                 ...
                 */
                TianJiXianLingMediator.prototype.onRefreshData = function (anyetasks, infoData) {
                    if (!anyetasks && !infoData) { //如果全是undfine，说明已经参加了天机仙令了
                        this._anyetasks = tianjixianling.models.TianJiXianLingModel._instance.someRoundTasks; //获取之前保存在model里的随机任务数据
                    }
                    else if (anyetasks.length == 1) { //如果传过来的数据长度为1，说明刷新某一轮的随机任务数据中某个随机任务数据
                        /** 临时存放随机任务数据 */
                        var _tempTaskData = anyetasks;
                        /** 原来8个随机任务数据 */
                        var _someRoundTasks = tianjixianling.models.TianJiXianLingModel._instance.someRoundTasks;
                    ...
                    if (infoData) {
                        ...
                        this._tjxlInfoData = tianjixianling.models.TianJiXianLingModel._instance.tjxlInfoData;
                    }
                    //UI界面的初始化
                    this._initUI();
                    this.onShow();
                 ...
                 * 显示界面
                 */
                TianJiXianLingMediator.prototype.onShow = function () {
                    this._viewUI.visible = true;
                };
                /**
                 * 初始化
                 */
                TianJiXianLingMediator.prototype._init = function () {
                    this.dataInit();
                    //this._initUI();
                };
                /**
                 * 数据初始化
                 */
                TianJiXianLingMediator.prototype.dataInit = function () {
                    this.levelInit();
                    this.configDataInit();
                };
                /**
                 * 配置数据初始化
                 */
                TianJiXianLingMediator.prototype.configDataInit = function () {
                };
                /**
                 * 玩家等级初始化
                 */
                TianJiXianLingMediator.prototype.levelInit = function () {
                ...
                /** 飘窗提示处于组队状态 */
                TianJiXianLingMediator.prototype._showInTeamTips = function () {
                ...
                TianJiXianLingMediator.prototype.hide = function () {
                    this.hideUI();
                    _super.prototype.hide.call(this);
                    modules.mainhud.models.HudProxy.getInstance().event(modules.mainhud.models.CLOSEVIEW_EVENT);
                };
                TianJiXianLingMediator.prototype.getView = function () {
                    return this._viewUI;
                };
                return TianJiXianLingMediator;
            }(game.modules.UiMediator));
            tianjixianling.TianJiXianLingMediator = TianJiXianLingMediator;
        })(tianjixianling = modules.tianjixianling || (modules.tianjixianling = {}));
    })(modules = game.modules || (game.modules = {}));
})(game || (game = {}));
//# sourceMappingURL=TianJiXianLingMediator.js.map