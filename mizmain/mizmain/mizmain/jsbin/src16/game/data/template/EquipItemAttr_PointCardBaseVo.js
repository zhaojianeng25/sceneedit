...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var EquipItemAttr_PointCardBaseVo = /** @class */ (function () {
                function EquipItemAttr_PointCardBaseVo() {
                }
                EquipItemAttr_PointCardBaseVo.prototype.parse = function (data) {
                ...
                return EquipItemAttr_PointCardBaseVo;
            }());
            template.EquipItemAttr_PointCardBaseVo = EquipItemAttr_PointCardBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=EquipItemAttr_PointCardBaseVo.js.map