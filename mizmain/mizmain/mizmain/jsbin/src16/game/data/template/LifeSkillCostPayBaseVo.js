...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var LifeSkillCostPayBaseVo = /** @class */ (function () {
                function LifeSkillCostPayBaseVo() {
                }
                LifeSkillCostPayBaseVo.prototype.parse = function (data) {
                ...
                return LifeSkillCostPayBaseVo;
            }());
            template.LifeSkillCostPayBaseVo = LifeSkillCostPayBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=LifeSkillCostPayBaseVo.js.map