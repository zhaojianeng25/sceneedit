    ...
    (function (me) {
        var ObjDataManager = /** @class */ (function (_super) {
            ...
            ObjDataManager.prototype.loadObjCom = function ($byte, $url) {
                ...
                ////console.log($objData);
                var $objData = new me.ObjData();
                var byte = new me.Pan3dByteArray($byte);
                ...
                if (version >= 20) {
                    ...
                    me.BaseRes.readFloatTwoByte(byte, $objData.vertices);
                    me.BaseRes.readFloatTwoByte(byte, $objData.uvs);
                    me.BaseRes.readFloatOneByte(byte, $objData.lightuvs);
                    me.BaseRes.readFloatTwoByte(byte, $objData.normals);
                    me.BaseRes.readIntForTwoByte(byte, $objData.indexs);
                    me.BaseRes.readFloatTwoByte(byte, $objData.tangents);
                    me.BaseRes.readFloatTwoByte(byte, $objData.bitangents);
                    $objData.vertexBuffer = me.Scene_data.context3D.uploadBuff3D($objData.vertices);
                    $objData.uvBuffer = me.Scene_data.context3D.uploadBuff3D($objData.uvs);
                    $objData.lightUvBuffer = me.Scene_data.context3D.uploadBuff3D($objData.lightuvs);
                    $objData.normalsBuffer = me.Scene_data.context3D.uploadBuff3D($objData.normals);
                }
                $objData.treNum = $objData.indexs.length;
                $objData.indexBuffer = me.Scene_data.context3D.uploadIndexBuff3D($objData.indexs);
            ...
            ObjDataManager.prototype.readObj2OneBuffer = function (byte, $objData) {
                ...
                me.BaseRes.readBytes2ArrayBuffer(byte, data, 2, lightuvsOffsets, dataWidth, 1); //lightuvs
                ...
                $objData.vertexBuffer = me.Scene_data.context3D.uploadBuff3DArrayBuffer(arybuff);
            ...
            ObjDataManager.prototype.creatTBNBuffer = function ($objData) {
                $objData.tangentBuffer = me.Scene_data.context3D.uploadBuff3D($objData.tangents);
                $objData.bitangentBuffer = me.Scene_data.context3D.uploadBuff3D($objData.bitangents);
            };
            return ObjDataManager;
        }(me.ResGC));
        me.ObjDataManager = ObjDataManager;
