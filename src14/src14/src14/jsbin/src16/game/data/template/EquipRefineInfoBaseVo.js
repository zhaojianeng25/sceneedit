...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var EquipRefineInfoBaseVo = /** @class */ (function () {
                function EquipRefineInfoBaseVo() {
                }
                EquipRefineInfoBaseVo.prototype.parse = function (data) {
                ...
                return EquipRefineInfoBaseVo;
            }());
            template.EquipRefineInfoBaseVo = EquipRefineInfoBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=EquipRefineInfoBaseVo.js.map