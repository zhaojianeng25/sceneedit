...
(function (Pan3d) {
    ...
    (function (me) {
        var DynamicTexItem = /** @class */ (function (_super) {
            ...
            DynamicTexItem.prototype.destory = function () {
                ...
                if (this._textureDynamic) {
                    me.Scene_data.context3D.deleteTexture(this._textureDynamic);
                }
                //if (this.textureRes){
            ...
            DynamicTexItem.prototype.creatTextureByCurve = function () {
                ...
                var img = me.ColorTransition.getInstance().getImageDataByVec(imgNumVec, this.life);
                this._textureDynamic = me.Scene_data.context3D.getTexture(img);
            };
        ...
        }(me.DynamicBaseTexItem));
        me.DynamicTexItem = DynamicTexItem;
