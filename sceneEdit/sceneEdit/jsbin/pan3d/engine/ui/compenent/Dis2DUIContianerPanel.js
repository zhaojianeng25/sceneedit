    ...
    (function (me) {
        var Disp2DBaseText = /** @class */ (function () {
            function Disp2DBaseText() {
                this.dtime = -1;
                this.time = 0;
                this.oldPos = new me.Vector2D();
            }
            Disp2DBaseText.prototype.needUpData = function ($pos) {
                if (this.oldPos.x != $pos.x || this.oldPos.y != $pos.y || me.Scene_data.cam3D.needChange) {
                    this.oldPos.x = $pos.x;
                    this.oldPos.y = $pos.y;
                    return true;
                }
            ...
            Disp2DBaseText.prototype.Vector3DToVector2D = function ($pos) {
                ...
                v2d.x = ((p.x / p.w) + 1) * (me.Scene_data.stageWidth / 2) / me.UIData.Scale - this.ui.width / 2;
                v2d.y = ((-p.y / p.w) + 1) * (me.Scene_data.stageHeight / 2) / me.UIData.Scale - this.ui.height / 2;
                return v2d;
            };
        ...
        me.Disp2DBaseText = Disp2DBaseText;
        //用于显示同屏2D容器，
        var Dis2DUIContianerPanel = /** @class */ (function (_super) {
            ...
            Dis2DUIContianerPanel.prototype.creatBaseRender = function () {
                this._baseRender = new me.UIRenderComponent;
            };
            //显示单元类, 尺寸，数量
            Dis2DUIContianerPanel.prototype.initData = function ($classVo, $rect, $num) {
                ...
                this._textureRect = new me.Rectangle(0, 0, kkwA, kkhB);
                this._baseRender.uiAtlas = new me.UIAtlas();
                var $uiAtlas = this._baseRender.uiAtlas;
                $uiAtlas.configData = new Array();
                $uiAtlas.ctx = me.UIManager.getInstance().getContext2D(this._textureRect.width, this._textureRect.height, false);
        ...
        }(me.Dis2DUIContianerBase));
        me.Dis2DUIContianerPanel = Dis2DUIContianerPanel;
