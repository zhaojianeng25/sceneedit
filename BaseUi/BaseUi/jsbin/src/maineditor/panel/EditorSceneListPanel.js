...
(function (maineditor) {
    ...
    var EditorSceneListPanel = /** @class */ (function (_super) {
        __extends(EditorSceneListPanel, _super);
        function EditorSceneListPanel($classVo, $rect, $num) {
        ...
        EditorSceneListPanel.prototype.creatBaseRender = function () {
            this._baseRender = new UIRenderComponent;
        };
        //显示单元类, 尺寸，数量
        EditorSceneListPanel.prototype.initData = function ($classVo, $rect, $num) {
        ...
        EditorSceneListPanel.prototype.mathSize = function ($rect, $num) {
            $rect.x = 0;
            $rect.y = 0;
        ...
        EditorSceneListPanel.prototype.makeBaseUi = function ($classVo) {
            var $uiAtlas = this._baseRender.uiAtlas;
        ...
        EditorSceneListPanel.prototype.showTemp = function ($data) {
            this.clearLostItem();
            var empty;
        ...
        EditorSceneListPanel.prototype.clearLostItem = function () {
        ...
        EditorSceneListPanel.prototype.playLost = function () {
            if (this._lostItem.length) {
                this.showTemp(this._lostItem.pop());
            }
        };
        EditorSceneListPanel.prototype.clearOneTemp = function () {
            for (var i = 0; i < this._uiItem.length; i++) {
        ...
        EditorSceneListPanel.prototype.clearTemp = function ($data) {
            for (var i = 0; i < this._uiItem.length; i++) {
        ...
        EditorSceneListPanel.prototype.getVoByData = function (value) {
            for (var i = 0; i < this._uiItem.length; i++) {
        ...
        EditorSceneListPanel.prototype.getVoByUi = function ($ui) {
            for (var i = 0; i < this._uiItem.length; i++) {
                if (this._uiItem[i].data) {
        ...
        EditorSceneListPanel.prototype.clearAll = function () {
            for (var i = 0; i < this._uiItem.length; i++) {
                if (this._uiItem[i].data) {
        ...
        EditorSceneListPanel.prototype.update = function (t) {
            for (var i = 0; i < this._uiItem.length; i++) {
                if (this._uiItem[i].data) {
        ...
        EditorSceneListPanel.prototype.getUiItemLen = function () {
            var $num = 0;
            for (var i = 0; i < this._uiItem.length; i++) {
                if (this._uiItem[i].data) {
                    $num++;
        ...
        return EditorSceneListPanel;
    }(base.BaseWindow));
    maineditor.EditorSceneListPanel = EditorSceneListPanel;
})(maineditor || (maineditor = {}));
//# sourceMappingURL=EditorSceneListPanel.js.map