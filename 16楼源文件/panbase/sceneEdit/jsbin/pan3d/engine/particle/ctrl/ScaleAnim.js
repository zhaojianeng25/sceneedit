    ...
    (function (me) {
        var ScaleAnim = /** @class */ (function (_super) {
            ...
            ScaleAnim.prototype.coreCalculate = function () {
                var frameNum = float2int(this.time / me.Scene_data.frameTime);
            ...
            Object.defineProperty(ScaleAnim.prototype, "data", {
                set: function (value) {
                    ...
                    if (this.scaleAry.length) {
                        frameNum = (this.scaleAry[this.scaleAry.length - 1].beginTime + this.scaleAry[this.scaleAry.length - 1].time) / me.Scene_data.frameTime;
                    ...
                    for (i = 0; i < frameNum; i++) {
                        var ctime = me.Scene_data.frameTime * i;
