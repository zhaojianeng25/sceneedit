    ...
    (function (me) {
        var UIRenderComponent = /** @class */ (function () {
            ...
            UIRenderComponent.prototype.createFrame = function ($upskin) {
                var frameMc = new me.FrameCompenent;
            ...
            UIRenderComponent.prototype.update = function () {
                ...
                if (this.mask) {
                    var renderContext = me.Scene_data.context3D.renderContext;
                ...
                if (this.mask) {
                    me.Scene_data.context3D.renderContext.disable(me.Scene_data.context3D.renderContext.STENCIL_TEST);
                }
            ...
            UIRenderComponent.prototype.interactiveEvent = function ($e) {
                ...
                var tf = false;
                for (var i = 0; i < this._uiList.length; i++) {
                    if (this._uiList[i].interactiveEvent($e) && me.UIManager.cando) {
                        tf = true;
                        me.UIManager.cando = false;
                        return true;
                    }
                }
                return tf;
        ...
        me.UIRenderComponent = UIRenderComponent;
