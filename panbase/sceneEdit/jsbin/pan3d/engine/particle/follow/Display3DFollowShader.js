    ...
    (function (me) {
        var Display3DFollowShader = /** @class */ (function (_super) {
            ...
            Display3DFollowShader.prototype.getMat4Str = function (key) {
                return "vcmat[" + me.Display3DBallShader.shader_mat4[key] + "]";
            };
            Display3DFollowShader.prototype.getVec4Str = function (key) {
                return "vcmat[" + me.Display3DBallShader.shader_vec4[key][0] + "][" + me.Display3DBallShader.shader_vec4[key][1] + "]";
            ...
            Display3DFollowShader.prototype.getVertexShaderString = function () {
                ...
                defineBaseStr =
                    "attribute vec4 vPosition;\n" +
                        ...
                        "uniform mat4 vcmat[" + me.Display3DBallShader.getVcSize() + "];\n" + //所有vc值
        ...
        me.Display3DFollowShader = Display3DFollowShader;
