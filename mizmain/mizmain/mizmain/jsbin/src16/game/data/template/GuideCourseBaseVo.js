...
(function (game) {
    ...
    (function (data_1) {
        var template;
        (function (template) {
            var GuideCourseBaseVo = /** @class */ (function () {
                function GuideCourseBaseVo() {
                }
                GuideCourseBaseVo.prototype.parse = function (data) {
                ...
                return GuideCourseBaseVo;
            }());
            template.GuideCourseBaseVo = GuideCourseBaseVo;
        })(template = data_1.template || (data_1.template = {}));
    })(data = game.data || (game.data = {}));
})(game || (game = {}));
//# sourceMappingURL=GuideCourseBaseVo.js.map