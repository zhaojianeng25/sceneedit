    ...
    (function (me) {
        var BaseRes = /** @class */ (function (_super) {
            ...
            BaseRes.prototype.readZipObj = function () {
                ...
                var newByte = new me.Pan3dByteArray(zipedBuf);
            ...
            BaseRes.prototype.readImg = function () {
                ...
                var time = me.TimeUtil.getTimer();
                var ary = new Array;
                var urlAry = new Array;
                for (var i = 0; i < this.imgNum; i++) {
                    var url = me.Scene_data.fileRoot + this._byte.readUTF();
            ...
            BaseRes.prototype.readJpngImg = function ($url) {
                ...
                var comFun = function (evt) {
                    ...
                    var ctx = me.UIManager.getInstance().getContext2D(img.width, img.height);
            ...
            BaseRes.prototype.loadImg = function (img) {
                me.TextureManager.getInstance().addRes(img.url, img);
                this.countImg();
            };
            BaseRes.prototype.addImg = function ($url, img) {
                me.TextureManager.getInstance().addRes($url, img);
                this.countImg();
            };
            ...
            BaseRes.prototype.readObj = function ($srcByte) {
                ...
                for (var i = 0; i < objNum; i++) {
                    var url = me.Scene_data.fileRoot + $srcByte.readUTF();
                    var size = $srcByte.readInt();
                    var newByte = new me.Pan3dByteArray();
                    newByte.length = size;
                    $srcByte.readBytes(newByte, 0, size);
                    var objData = me.ObjDataManager.getInstance().loadObjCom(newByte.buffer, url);
                }
                if (this._imgFun) {
                    this._imgFun();
                }
            ...
            BaseRes.prototype.readMaterial = function () {
                ...
                for (var i = 0; i < objNum; i++) {
                    ...
                    var dataByte = new me.Pan3dByteArray;
                    dataByte.length = size;
                    this._byte.readBytes(dataByte, 0, size);
                    me.MaterialManager.getInstance().addResByte(url, dataByte);
            ...
            BaseRes.prototype.readParticle = function () {
                ...
                for (var i = 0; i < objNum; i++) {
                    ...
                    dataByte.length = size;
                    this._byte.readBytes(dataByte, 0, size);
                    me.ParticleManager.getInstance().addResByte(url, dataByte);
