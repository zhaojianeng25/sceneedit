...
(function (Pan3d) {
    ...
    (function (me) {
        ...
        me.TextJumpType = TextJumpType;
        var TextJumpUiVo = /** @class */ (function () {
            function TextJumpUiVo() {
            }
            return TextJumpUiVo;
        }());
        me.TextJumpUiVo = TextJumpUiVo;
        var ExpTextJumpUiDrawAndRefreash = /** @class */ (function (_super) {
            ...
            ExpTextJumpUiDrawAndRefreash.prototype.drawTxtBydigitalAndtext = function ($vo) {
                ...
                var ctx = me.UIManager.getInstance().getContext2D(rec.pixelWitdh, rec.pixelHeight, false);
                var picid = $vo.type;
                var $width = 50;
                var $height = 25;
                var txtcolor;
                if ($vo.type == TextJumpType.EXPERIENCE) {
                    txtcolor = me.ArtFont.num54;
                }
                var distion = me.ArtFont.getInstance().getAirFontWidth(ctx, String(this._data.str), txtcolor);
                distion += $width;
                me.UiDraw.cxtDrawImg(ctx, "TYPE" + picid, new me.Rectangle(rec.pixelWitdh - distion, rec.pixelHeight - $height, $width, $height), me.UIData.publicUi);
                me.ArtFont.getInstance().writeFontToCtxLeft(ctx, String(this._data.str), txtcolor, rec.pixelWitdh - distion + $width + 2, rec.pixelHeight - $height);
                me.TextureManager.getInstance().updateTexture(this.parent.uiAtlas.texture, rec.pixelX, rec.pixelY, ctx);
                return distion;
            };
            ExpTextJumpUiDrawAndRefreash.prototype.update = function () {
                if (this._data) {
                    this.time = me.TimeUtil.getTimer();
            ...
            ExpTextJumpUiDrawAndRefreash.prototype.changerules = function (t) {
                ...
                if (vo.type == Pan3d.me.TextJumpType.EXPERIENCE) {
                    var v2d = new me.Vector2D;
                    if (t < 0) {
                        v2d.x = -9999;
                    }
                    else {
                        v2d.x = 300 / me.UIData.Scale;
                        v2d.y = me.Scene_data.stageHeight / me.UIData.Scale - 50;
                    }
                    //玩家名
                    posy = v2d.y -= 15;
                    posy = posy - (t * 0.5);
        ...
        me.ExpTextJumpUiDrawAndRefreash = ExpTextJumpUiDrawAndRefreash;
        var TextJumpUiDrawAndRefreash = /** @class */ (function (_super) {
                ...
                if (this._data) {
                    ...
                    switch (vo.type) {
                        ...
                        case TextJumpType.TREATMENT:
                            //数字类
                            me.ArtFont.getInstance().writeFontToSkinName(this.parent.uiAtlas, this.textureStr, String(vo.str), "NUM" + (vo.type + 50), me.TextAlign.RIGHT);
                            break;
                        case TextJumpType.MYNORMALDAMAGEUP:
                        case TextJumpType.MYNORMALDAMAGE:
                            me.ArtFont.getInstance().writeFontToSkinName(this.parent.uiAtlas, this.textureStr, String(vo.str), me.ArtFont.num53, me.TextAlign.RIGHT);
                            break;
                        case TextJumpType.NORMALDAMAGEUP:
                            me.ArtFont.getInstance().writeFontToSkinName(this.parent.uiAtlas, this.textureStr, String(vo.str), "NUM" + (vo.type + 40), me.TextAlign.RIGHT);
                            break;
            ...
            TextJumpUiDrawAndRefreash.prototype.drawTxtBytext = function ($vo) {
                ...
                me.UiDraw.cxtDrawImg(ctx, "TYPE" + $vo.type, new me.Rectangle(rec.pixelWitdh - $length, rec.pixelHeight - 25, $length, 25), me.UIData.publicUi);
                me.TextureManager.getInstance().updateTexture(this.parent.uiAtlas.texture, rec.pixelX, rec.pixelY, ctx);
                return 50;
            };
            ...
            TextJumpUiDrawAndRefreash.prototype.changerules = function (t) {
                ...
                t = (t - vo.starttime) / 1000 * 60;
                var changevo = new Array();
                var v2d = this.Vector3DToVector2D(new me.Vector3D(this.pos.x, this.pos.y, this.pos.z));
                if (t < 0) {
                    v2d.x = -9999;
                }
                if (vo.type == Pan3d.me.TextJumpType.EXPERIENCE) {
            ...
            CharNameUiVo.prototype.makeData = function () {
                if (this._data) {
                    ...
                    if (this.lastKey != this.charNameMeshVo.name) {
                        ...
                        me.LabelTextFont.writeSingleLabel(this.parent.uiAtlas, this.textureStr, this.charNameMeshVo.name, 20, me.TextAlign.CENTER, "#ffffff", "#27262e");
                    }
                    ...
                    if (this.charNameMeshVo.pos) {
                        if (this.charNameMeshVo.visible) {
                            if (this.needUpData(this.charNameMeshVo.pos) || this.charNameMeshVo.visibleChange) {
                                var m = me.Scene_data.cam3D.cameraMatrix.clone(this.tempMatrix);
                                m.append(me.Scene_data.viewMatrx3D);
                                var p = m.transformVector(this.charNameMeshVo.pos);
                                this.ui.x = ((p.x / p.w) + 1) * (me.Scene_data.stageWidth / 2) / me.UIData.Scale - this.ui.width / 2;
                                this.ui.y = ((-p.y / p.w) + 1) * (me.Scene_data.stageHeight / 2) / me.UIData.Scale - this.ui.height / 2;
        ...
        var CharTitleUiVo = /** @class */ (function (_super) {
            ...
            CharTitleUiVo.prototype.makeData = function () {
                ...
                if (this._data) {
                    ...
                    me.LoadManager.getInstance().load(me.Scene_data.fileRoot + getUItittleUrl(String(this._charTitleMeshVo.num)), me.LoadManager.IMG_TYPE, function ($img) {
                        var $uiRec = _this.parent.uiAtlas.getRec(_this.textureStr);
                        _this.parent.uiAtlas.ctx = me.UIManager.getInstance().getContext2D($uiRec.pixelWitdh, $uiRec.pixelHeight, false);
                        ...
                        me.TextureManager.getInstance().updateTexture(_this.parent.uiAtlas.texture, $uiRec.pixelX, $uiRec.pixelY, _this.parent.uiAtlas.ctx);
                    });
                }
            };
        ...
        me.CharTitleUiVo = CharTitleUiVo;
...
(function (Pan3d) {
    ...
    (function (me) {
        ...
        me.BloodUIShader = BloodUIShader;
        ...
        me.BloodUICompenent = BloodUICompenent;
                    ...
                    if (this.bloodLineMeshVo.pos) {
                        if (this.bloodLineMeshVo.visible) {
                            if (this.needUpData(this.bloodLineMeshVo.pos) || this.bloodLineMeshVo.visibleChange) {
                                var m = me.Scene_data.cam3D.cameraMatrix.clone(this.tempMatrix);
                                m.append(me.Scene_data.viewMatrx3D);
                                var p = m.transformVector(new me.Vector3D(this.bloodLineMeshVo.pos.x, this.bloodLineMeshVo.pos.y, this.bloodLineMeshVo.pos.z));
                                this.ui.x = ((p.x / p.w) + 1) * (me.Scene_data.stageWidth / 2) / me.UIData.Scale - this.ui.width / 2;
                                this.ui.y = ((-p.y / p.w) + 1) * (me.Scene_data.stageHeight / 2) / me.UIData.Scale - this.ui.height / 2;
        ...
        me.BloodDisp2DBaseText = BloodDisp2DBaseText;
        var BloodUIRenderComponent = /** @class */ (function (_super) {
            ...
            BloodUIRenderComponent.prototype.initData = function () {
                ...
                me.ProgrmaManager.getInstance().registe(BloodUIShader.BloodUIShader, new BloodUIShader);
                this.shader = me.ProgrmaManager.getInstance().getProgram(BloodUIShader.BloodUIShader);
                this.program = this.shader.program;
                this.uiProLocation = me.Scene_data.context3D.getLocation(this.program, "ui");
                this.ui2ProLocation = me.Scene_data.context3D.getLocation(this.program, "lifenum");
            };
            BloodUIRenderComponent.prototype.update = function () {
                ...
                me.Scene_data.context3D.setBlendParticleFactors(this.blenderMode);
                me.Scene_data.context3D.setProgram(this.program);
                if (this.nextTime < me.TimeUtil.getTimer() || this.renderData2.length != this._uiList.length * 4) {
                    ...
                    this.nextTime = me.TimeUtil.getTimer() + 300;
                }
                me.Scene_data.context3D.setVc4fvLocation(this.uiProLocation, this.renderData);
                me.Scene_data.context3D.setVc4fvLocation(this.ui2ProLocation, this.renderData2);
                me.Scene_data.context3D.setVa(0, 3, this.objData.vertexBuffer);
                me.Scene_data.context3D.setVa(1, 3, this.objData.uvBuffer);
                if (this.uiAtlas) {
                    me.Scene_data.context3D.setRenderTexture(this.shader, "s_texture", this.uiAtlas.texture, 0);
                }
            ...
            BloodUIRenderComponent.prototype.creatBaseComponent = function ($skinName) {
                ...
                ui.tr.setRec(new me.UIRectangle(0, 0, 1, 1));
                ui.width = 64;
                ui.height = 8;
                ui.uiRender = this;
                ui.lifeNum = 100;
        ...
        me.BloodUIRenderComponent = BloodUIRenderComponent;
        var BloodLineUIConatiner = /** @class */ (function (_super) {
            ...
            function BloodLineUIConatiner() {
                ...
                _this._baseRender.uiAtlas = new me.UIAtlas;
        ...
        me.BloodLineUIConatiner = BloodLineUIConatiner;
    })(me = Pan3d.me || (Pan3d.me = {}));
})(Pan3d || (Pan3d = {}));
(function (Pan3d) {
    var me;
    (function (me) {
        ...
        me.CharTitleMeshVo = CharTitleMeshVo;
        ...
        me.CharNameMeshVo = CharNameMeshVo;
        ...
        me.BloodLineMeshVo = BloodLineMeshVo;
        ...
        me.JumpTextMeshVo = JumpTextMeshVo;
        ...
        }(me.Dis2DUIContianerPanel));
        me.JumpTxtContianerPanel = JumpTxtContianerPanel;
        var BloodManager = /** @class */ (function () {
            function BloodManager() {
                this.uiContianerItem = new Array();
                this._charTitleContianerPanel = new me.Dis2DUIContianerPanel(Pan3d.me.CharTitleUiVo, new me.Rectangle(0, 0, 131, 69), 10);
                this._charNameContianerPanel = new me.Dis2DUIContianerPanel(Pan3d.me.CharNameUiVo, new me.Rectangle(0, 0, 256, 24), 50);
                this._jumpTxtContianerPanel = new me.AlphaUiContianer(Pan3d.me.TextJumpUiDrawAndRefreash, new me.Rectangle(0, 0, 256, 50), 10);
                this._expjumpTxtContianerPanel = new me.AlphaUiContianer(Pan3d.me.ExpTextJumpUiDrawAndRefreash, new me.Rectangle(0, 0, 512, 100), 5);
            ...
            BloodManager.prototype.resize = function () {
                ...
                me.Scene_data.cam3D.needChange = true;
                //this.update();
            };
            return BloodManager;
        }());
        me.BloodManager = BloodManager;
    })(me = Pan3d.me || (Pan3d.me = {}));
})(Pan3d || (Pan3d = {}));
