    ...
    (function (me) {
        var SkillPath = /** @class */ (function () {
            function SkillPath() {
                ...
                * 当前方向
                */
                this._currentDirect = new me.Vector3D;
            }
            SkillPath.prototype.update = function (t) {
                ...
                if (!this.hasReached) {
                    var targetDistance = me.Vector3D.distance(this.currentPos, this.currentTargetPos);
