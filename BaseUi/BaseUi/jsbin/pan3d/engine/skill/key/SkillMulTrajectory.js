    ...
    (function (me) {
        var SkillMulTrajectory = /** @class */ (function (_super) {
            ...
            SkillMulTrajectory.prototype.addToRender = function () {
                ...
                if (!this.currentPosList) {
                    ...
                    for (var i = 0; i < this.activeList.length; i++) {
                        this.currentPosList.push(new me.Vector3D(this.activeList[i].x, this.activeList[i].y + 10, this.activeList[i].z + 5));
                    }
            ...
            SkillMulTrajectory.prototype.setMulPlayData = function ($activeList, $target, $removeCallFun, types) {
                ...
                if (!this.pathMul) {
                    this.pathMul = me.PathManager.getNewPath(types);
        ...
        me.SkillMulTrajectory = SkillMulTrajectory;
