    ...
    (function (me) {
        var Display3dShadow = /** @class */ (function (_super) {
            ...
            function Display3dShadow() {
                ...
                _this.shader = me.ProgrmaManager.getInstance().getProgram(me.Display3DShadowShader.Display3DShadowShader);
                _this.program = _this.shader.program;
                _this.posProLocation = me.Scene_data.context3D.getLocation(_this.program, "pos");
                return _this;
            }
