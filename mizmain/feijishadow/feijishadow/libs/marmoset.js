...
(function(marmoset) {
    ...
    PostRender.prototype.present = function(a, b, c, d) {
		...
		//	console.log(this.sampleIndex,"/",this.sampleCount)
			...
			if(a){
				// 1 > k && e.disable(e.BLEND), Framebuffer.bindNone(e), this.aaShader.bind(),this.aaBuffer.bind(this.aaShader.samplers.tInput), this.fillScreen(this.aaShader.attribs.vCoord)
			}
