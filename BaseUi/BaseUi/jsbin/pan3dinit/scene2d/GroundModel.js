...
(function (scene2d) {
    ...
    (function (me) {
        ...
        me.Ground2dBaseShader = Ground2dBaseShader;
        var Ground2dBaseSprite = /** @class */ (function (_super) {
            ...
            Ground2dBaseSprite.prototype.loadTexture = function () {
                var $ctx = Pan3d.me.UIManager.getInstance().getContext2D(128, 128, false);
            ...
            Ground2dBaseSprite.prototype.setPicUrl = function ($url) {
                ...
                Pan3d.me.TextureManager.getInstance().getTexture($url, function ($texture) {
            ...
            Ground2dBaseSprite.prototype.getMoveSizeData = function () {
                var $tx = (this.x + Ground2dBaseSprite.perentpos.x) / (Pan3d.me.Scene_data.stageWidth / 2) - 1;
                var $ty = 1 - (this.y + Ground2dBaseSprite.perentpos.y) / (Pan3d.me.Scene_data.stageHeight / 2);
                var $tw = this.width / (Pan3d.me.Scene_data.stageWidth / 2);
                var $th = this.height / (Pan3d.me.Scene_data.stageHeight / 2);
                return [$tx, $ty, $tw, $th];
            };
            Ground2dBaseSprite.perentpos = new Pan3d.me.Vector2D();
            return Ground2dBaseSprite;
        }(Pan3d.me.Display3D));
        me.Ground2dBaseSprite = Ground2dBaseSprite;
