    ...
    (function (me) {
        var UICompenent = /** @class */ (function (_super) {
            ...
            UICompenent.prototype.applyRenderSize = function () {
                ...
                this.renderX = this.absoluteX / me.Scene_data.stageWidth;
                this.renderY = this.absoluteY / me.Scene_data.stageHeight;
                this.renderWidth = this.absoluteWidth / me.Scene_data.stageWidth;
                this.renderHeight = this.absoluteHeight / me.Scene_data.stageHeight;
                if (this._uvScale >= 0) {
            ...
            UICompenent.prototype.applyAbsolutePoint = function () {
                if (this.parent) {
                    var uiscale = me.UIData.Scale * this.parent.uiScale;
                    if (this._xType == -1) {
                        ...
                        this.absoluteX = me.Scene_data.stageWidth - this._right * uiscale - this.width * uiscale;
                    }
                    else if (this._xType == 2) {
                        this.absoluteX = this._center * uiscale + me.Scene_data.stageWidth / 2 - this.width * uiscale / 2;
                    }
                    if (this._yType == -1) {
                        ...
                        this.absoluteY = me.Scene_data.stageHeight - this._bottom * uiscale - this.height * uiscale;
                    }
                    else if (this._yType == 2) {
                        this.absoluteY = this._middle * uiscale + me.Scene_data.stageHeight / 2 - this.height * uiscale / 2;
                    }
