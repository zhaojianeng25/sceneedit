...
(function (Pan3d) {
    ...
    (function (me) {
        ...
        var FpsStage = /** @class */ (function () {
            function FpsStage() {
                this.lastTime = 0;
                this.cPos = new me.Vector2D(150, 100);
            }
            ...
            FpsStage.prototype.init = function ($cadves, $loadCav) {
                ...
                me.TimeUtil.addFrameTick(function () { _this.upData(); });
            };
            ...
            FpsStage.prototype.upData = function () {
                this.fps.drawNum++;
                if (this.lastTime >= me.TimeUtil.getTimer() - 1000) {
                    return;
                }
            ...
            FpsStage.prototype.makeXyzLine = function () {
                var xPos = new me.Vector3D(80, 0, 0);
                var yPos = new me.Vector3D(0, 70, 0);
                var zPos = new me.Vector3D(0, 0, 80);
                var $m = new me.Matrix3D;
                $m.appendRotation(me.Scene_data.cam3D.rotationY, me.Vector3D.Y_AXIS);
                $m.appendRotation(me.Scene_data.cam3D.rotationX, me.Vector3D.X_AXIS);
                xPos = $m.transformVector(xPos);
                yPos = $m.transformVector(yPos);
                zPos = $m.transformVector(zPos);
                this.drawLine(new me.Vector2D(0, 0), new me.Vector2D(xPos.x, -xPos.y), "#ff0000");
                this.drawLine(new me.Vector2D(0, 0), new me.Vector2D(yPos.x, -yPos.y), "#00ff00");
                this.drawLine(new me.Vector2D(0, 0), new me.Vector2D(zPos.x, -zPos.y), "#0000ff");
            ...
            FpsStage.prototype.resetSize = function () {
                this.cPos = new me.Vector2D(150, me.Scene_data.stageHeight - 100);
            };
            FpsStage.showFps = false;
            return FpsStage;
        }());
        me.FpsStage = FpsStage;
