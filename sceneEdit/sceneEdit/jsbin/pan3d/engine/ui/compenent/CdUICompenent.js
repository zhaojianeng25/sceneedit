    ...
    (function (me) {
        var CdRenderComponent = /** @class */ (function (_super) {
            ...
            CdRenderComponent.prototype.initProgram = function () {
                me.ProgrmaManager.getInstance().registe(CdUIShader.CdUIShader, new CdUIShader);
                this.shader = me.ProgrmaManager.getInstance().getProgram(CdUIShader.CdUIShader);
                ...
                this.dataTProLocation = me.Scene_data.context3D.getLocation(this.program, "dataT");
            };
        ...
        me.CdRenderComponent = CdRenderComponent;
        var CdUICompenent = /** @class */ (function (_super) {
            ...
            CdUICompenent.prototype.update = function () {
                if (this.cdTotalnum != 0) {
                    var n = (me.TimeUtil.getTimer() - this.lastTime) / this.cdTotalnum;
                    if (n < 1) {
                        this.setCdNum(n);
                    }
                    else {
            ...
            CdUICompenent.prototype.setVc = function (program, index) {
                ...
                me.Scene_data.context3D.setVc4fv(program, "dataTime[" + index + "]", [nk, this.clockwise ? 0 : 1, 0, 1]);
            };
