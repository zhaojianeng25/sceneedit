    ...
    (function (me) {
        var ParticleData = /** @class */ (function () {
            ...
            ParticleData.prototype.setAllByteInfo = function ($byte) {
                this.timelineData = new me.TimeLineData();
                ...
                this._life = this._life > 10000 ? me.Scene_data.MAX_NUMBER : this._life;
                this._watchEye = $byte.readBoolean();
                this._ziZhuanAngly = new me.Vector3D();
            ...
            Object.defineProperty(ParticleData.prototype, "materialByteUrl", {
                set: function (value) {
                    ...
                    me.MaterialManager.getInstance().getMaterialByte(me.Scene_data.fileRoot + value, function ($matrial) { _this.onMaterialLoad($matrial); });
                },
                enumerable: true,
                configurable: true
            });
            ParticleData.prototype.onMaterialLoad = function ($matrial) {
                this.materialParam = new me.MaterialParam;
                ...
                me.MaterialManager.getInstance().loadDynamicTexUtil(this.materialParam);
                this.regShader();
            };
            ...
            ParticleData.prototype.getBzData = function ($ax, $bx, ar, br, $speedNum) {
                var num80 = 10;
                var a = new me.Vector2D(0, $ax * num80);
                var d = new me.Vector2D($speedNum, $bx * num80);
                var m = new me.Matrix3D;
                var p = new me.Vector3D;
                m.identity();
                m.appendRotation(-ar, me.Vector3D.Z_AXIS);
                p = m.transformVector(new me.Vector3D($speedNum / 2, 0, 0));
                var b = new me.Vector2D($speedNum / 2, a.y + p.y);
                m.identity();
                m.appendRotation(-br, me.Vector3D.Z_AXIS);
                p = m.transformVector(new me.Vector3D(-$speedNum / 2, 0, 0));
                var c = new me.Vector2D($speedNum / 2, d.y + p.y);
                var ary = [a, b, c, d];
            ...
            ParticleData.prototype.drawbezier = function (_array, _time) {
                ...
                for (var i in _array) {
                    _newarray.push(new me.Vector2D(_array[i].x, _array[i].y));
                }
