    ...
    (function (me) {
        var SkillTrajectory = /** @class */ (function (_super) {
            ...
            function SkillTrajectory() {
                ...
                _this._currentPos = new me.Vector3D;
                _this.rotationMatrix = new me.Matrix3D;
                _this._socketMaxrix = new me.Matrix3D;
                _this._currentTargetPos = new me.Vector3D;
                return _this;
            ...
            SkillTrajectory.prototype.reset = function () {
                ...
                //if(false){ 
                if (this.endParticle) {
                    me.ParticleManager.getInstance().addParticle(this.endParticle);
            ...
            SkillTrajectory.prototype.endPlayFun = function (e) {
                if (e === void 0) { e = null; }
                me.ParticleManager.getInstance().removeParticle(this.endParticle);
                this.endParticle.removeEventListener(me.BaseEvent.COMPLETE, this.endPlayFun, this);
            };
            ...
            SkillTrajectory.prototype.addToRender = function () {
                ...
                if (this.data.beginType == 0) {
                    var ma = new me.Matrix3D;
                    ma.appendRotation(this.active.rotationY, me.Vector3D.Y_AXIS);
            ...
            SkillTrajectory.prototype.setInfo = function (obj) {
                ...
                if (this.data.endParticleUrl) {
                    this.endParticle = me.ParticleManager.getInstance().getParticleByte(me.Scene_data.fileRoot + this.data.endParticleUrl);
                    this.endParticle.addEventListener(me.BaseEvent.COMPLETE, this.endPlayFun, this);
                }
            };
            SkillTrajectory.prototype.setPlayData = function ($active, $target, $removeCallFun, types, $bloodFun) {
                ...
                if (!this.path) {
                    this.path = me.PathManager.getNewPath(2);
        ...
        me.SkillTrajectory = SkillTrajectory;
