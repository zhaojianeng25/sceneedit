...
module game.data.template {
    export class EquipEffectBaseVo {
        /**编号 id */
        public id: number; 
        /**装备颜色 */
        public equipcolor: number; 
        /**属性名1,属性名2,属性名3,属性名4,属性名5,属性名6  */
        public baseEffectType: Array<number>; 
        /**属性值1,属性值2,属性值3,属性值4,属性值5,属性值6 */
        public baseEffect: Array<number>; 
        /**性别需求  */
        public sexNeed: number; 
        /**绿色评分,蓝色评分,紫色评分,橙色评分,暗金色评分 */
        public scorecolor: Array<number>;
        /**角色需求1,角色需求2  */
        public roleNeed: Array<number>; 
        /**可否摆摊上架 */
        public bCanSale: number; 
        /**点卡服可否摆摊上架 */
        public dbCanSale: number; 
        /**出售价格系数 出售价格系数 */
        public sellpricecoef: number; 
        /**耐久度系数耐久度系数 */
        public endurecoef: number; 
        /**套装id */
        public suiting: number; 
        /**武器造型编号 */
        public weaponid: number; 
        /**武器特效编号 */
        public weaponeffectid: number; 
        /**左手路径1,左手路径2		装备在场景里对应的精灵 */
        public modelpathleft: Array<string>; 
        /**右手路径1,右手路径2 */
        public modelpathright: Array<string>; 
        /**左手挂点1,左手挂点2			装备如果是左手，左手的挂点名 */
        public socketleft: Array<string>; 
        /**右手挂点1,右手挂点2			装备如果是右手，右手的挂点名 */
        public socketright: Array<string>; 
        /**职业需求 */
        public needCareer: string; 
        /**部件ID */
        public eequiptype: number; 
