    ...
    (function (me) {
        var Shader3D = /** @class */ (function (_super) {
            ...
            Shader3D.prototype.encode = function () {
                ...
                var $context = me.Scene_data.context3D.renderContext;
            ...
            Shader3D.prototype.getWebGLUniformLocation = function ($name) {
                ...
                if (local) {
                    ...
                    this.localDic[$name] = me.Scene_data.context3D.getLocation(this.program, $name);
            ...
            Shader3D.prototype.destory = function () {
                ...
                this.name = null;
                this.localDic = null;
                me.Scene_data.context3D.deleteShader(this);
            };
            return Shader3D;
        }(me.ResCount));
        me.Shader3D = Shader3D;
