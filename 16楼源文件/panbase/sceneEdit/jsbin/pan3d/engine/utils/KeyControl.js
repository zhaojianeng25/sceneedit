    ...
    (function (me) {
        ...
        var KeyControl = /** @class */ (function () {
            function KeyControl() {
                ...
                this._lostMousePos = new me.Object3D;
                this._lastFousce = new me.Object3D;
            ...
            KeyControl.prototype.onMouseMove = function ($evt) {
                ...
                var $nowPos = new me.Object3D;
                $nowPos.x = $evt.pageX;
                $nowPos.y = $evt.pageY;
                if ($keyControl._isMouseDown) {
                    me.Scene_data.cam3D.rotationY = $keyControl._lastFousce.rotationY - ($nowPos.x - $keyControl._lostMousePos.x) / 10;
                    me.Scene_data.cam3D.rotationX = $keyControl._lastFousce.rotationX - ($nowPos.y - $keyControl._lostMousePos.y) / 10;
                }
            };
            KeyControl.prototype.onMouseDown = function ($evt) {
                ...
                $keyControl._lastFousce.rotationX = me.Scene_data.cam3D.rotationX;
                $keyControl._lastFousce.rotationY = me.Scene_data.cam3D.rotationY;
            };
            ...
            KeyControl.prototype.upData = function () {
                ...
                if (_keyDic[81]) { //Q
                    me.Scene_data.cam3D.y -= this.speedNum;
                }
                if (_keyDic[69]) { //E
                    me.Scene_data.cam3D.y += this.speedNum;
                }
                me.MathClass.MathCam(me.Scene_data.cam3D);
            };
            KeyControl.prototype.tureLeft = function () {
                var $p = new me.Vector3D(-this.speedNum, 0, 0, 1); //dis
            ...
            KeyControl.prototype.tureUp = function () {
                var $p = new me.Vector3D(0, 0, this.speedNum, 1); //dis
                this.mathFocus3D($p);
            };
            ...
            KeyControl.prototype.mathFocus3D = function ($p) {
                ...
                me.Scene_data.cam3D.x += $p.x;
                me.Scene_data.cam3D.y += $p.y;
                me.Scene_data.cam3D.z += $p.z;
            };
