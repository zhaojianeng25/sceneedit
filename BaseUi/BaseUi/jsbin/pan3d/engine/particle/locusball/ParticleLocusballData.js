    ...
    (function (me) {
        var ParticleLocusballData = /** @class */ (function (_super) {
            ...
            ParticleLocusballData.prototype.getParticle = function () {
                return new me.Display3DLocusBallPartilce;
            };
            ParticleLocusballData.prototype.initBasePos = function () {
                ...
                for (var i = 0; i < this._totalNum; i++) {
                    ...
                    if (this._isRandom) {
                        ...
                        v3d = new me.Vector3D(this._posAry[index] + Math.random() * roundv3d.x, this._posAry[index + 1] + Math.random() * roundv3d.y, this._posAry[index + 2] + Math.random() * roundv3d.z);
                    }
                    else {
                        v3d = new me.Vector3D(this._posAry[index], this._posAry[index + 1], this._posAry[index + 2]);
                    }
            ...
            ParticleLocusballData.prototype.initSpeed = function () {
                ...
                for (var i = 0; i < this._totalNum; i++) {
                    ...
                    if (this._tangentSpeed == 0) {
                        ...
                        var v3d = new me.Vector3D(this._tangentAry[i * 3], this._tangentAry[i * 3 + 1], this._tangentAry[i * 3 + 2]);
        ...
        me.ParticleLocusballData = ParticleLocusballData;
