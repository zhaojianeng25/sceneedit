module materialui {
    ...
    export class ResultNodeUI extends BaseMaterialNodeUI {
        ...
        private initItem(): void {
            this.diffuseItem = new ItemMaterialUI("漫反射", MaterialItemType.VEC3);

            this.normalItem = new ItemMaterialUI("法线", MaterialItemType.VEC3);
            this.reflectItem = new ItemMaterialUI("反射", MaterialItemType.VEC3);

            this.alphaItem = new ItemMaterialUI("透明度", MaterialItemType.FLOAT);
            this.killItem = new ItemMaterialUI("不透明蒙版", MaterialItemType.FLOAT);
