...
module game.scene{
	 ...
	 * 沙尘暴
	 */
	export class WeatherSandstorms extends WeatherBase {
		...
		constructor(app: AppBase) {
			...
			this._assetsLoader.load([Path.atlas_scene + "weather/sandstorms.atlas"], Handler.create(this, this.onResComplete));
		}

		protected onResComplete(): void {
			let path = 'scene/weather/sandstorms/'
