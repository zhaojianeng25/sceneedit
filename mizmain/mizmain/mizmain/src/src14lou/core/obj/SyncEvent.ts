module core.obj {
	...
	export const OBJ_OPT_NEW: number = 0x01;		//新对象
	export const OBJ_OPT_DELETE: number = 0x02;	//删除对象
	export const OBJ_OPT_UPDATE: number = 0x04;	//对象更新
	export const OBJ_OPT_BINLOG: number = 0x08;	//BINLOG方式
	export const OBJ_OPT_U_GUID: number = 0x10;	//打包方式ID为整形

	export const OPT_SET: number = 0x01;
	export const OPT_UNSET: number = 0x02;
	export const OPT_ADD: number = 0x04;
	export const OPT_SUB: number = 0x08;

	export const TYPE_UINT32: number = 0;
	export const TYPE_UINT16: number = 1;
	export const TYPE_UINT8: number = 2;
	export const TYPE_BIT: number = 3;
	export const TYPE_UINT64: number = 4;
	export const TYPE_INT32: number = 5;
	export const TYPE_STRING: number = 6;
	export const TYPE_INT16: number = 7;
	export const TYPE_INT8: number = 8;
	export const TYPE_FLOAT: number = 9;
	export const TYPE_DOUBLE: number = 10;

	export const ATOMIC_OPT_RESULT_NO: number = 0;		//不是原子操作
	export const ATOMIC_OPT_RESULT_TRY: number = 1;	//尝试原子操作
	export const ATOMIC_OPT_RESULT_OK: number = 2;		//原子操作成功
	export const ATOMIC_OPT_RESULT_FAILED: number = -1;	//原子操作失败

	export class SyncEvent extends Laya.EventDispatcher {
