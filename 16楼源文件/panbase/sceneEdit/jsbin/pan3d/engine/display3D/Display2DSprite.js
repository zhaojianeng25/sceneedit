    ...
    (function (me) {
        var Display2DSprite = /** @class */ (function (_super) {
            ...
            function Display2DSprite() {
                ...
                _this.shader = me.ProgrmaManager.getInstance().getProgram(me.Sprite2DShader.SPRITE2D_SHADER);
                _this.program = _this.shader.program;
                return _this;
            }
            Display2DSprite.prototype.setInfo = function ($configurl, $imgurl, $fun) {
                if (!this._imgAtlas) {
                    this._imgAtlas = new me.UIAtlas;
                }
            ...
            Display2DSprite.prototype.update = function () {
                ...
                me.Scene_data.context3D.setRenderTexture(this.shader, "s_texture", this._imgAtlas.texture, 0);
        ...
        me.Display2DSprite = Display2DSprite;
